...
class Clearable {
    static createCloseButton() {
        ...
        const closeIcon = `<span class="t3js-icon icon icon-size-small icon-state-default icon-actions-close" data-identifier="actions-close">
    ...
    registerClearable() {
        HTMLInputElement.prototype.clearable = function (options = {}) {
...
var Clearable$1 = new Clearable();

export default Clearable$1;
