...
import { SettingsMode } from '@typo3/backend/settings/enum/settings-mode.enum';
...
class SystemSettings extends AbstractInteractableModule {
  ...
  private async getContent(): Promise<void> {
    ...
    editor.mode = SettingsMode.advanced;
    editor.categories = categories;
    editor.formName = 'system-settings-editor';

    editor.addEventListener(SettingsEditorSubmitEvent.eventName, async (event: SettingsEditorSubmitEvent): Promise<void> => {
