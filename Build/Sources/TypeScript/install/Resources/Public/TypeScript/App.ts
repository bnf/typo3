...
export class InstallModule extends LitElement {
                    ...
                    <div class="topbar-header t3js-topbar-header" style="padding-left: 0">
                        <div class="topbar-header-site">
                            ...
                            <button type="button" class="btn btn-default btn-danger pull-right t3js-login-lockInstallTool" style="margin-top: 7px; margin-right: 15px;">
                                <typo3-backend-icon icon="actions-logout" size="small"><typo3-backend-icon>
                                Logout
                            </button>
                        </div>
                    </div>
                ...
                <ul class="modulemenu-group-container">
                    ...
                    <li data-level="1">
                        <a href="index.php"
                            ...
                            data-link="index.php"
                        >
                            <span class="modulemenu-icon" aria-hidden="true"><typo3-backend-icon icon="modulegroup-web" size="default"></typo3-backend-icon></span>
                    ...
                    <li data-level="1">
                        <a href="../index.php"
                            ...
                            id="frontend"
                        >
                            <span class="modulemenu-icon" aria-hidden="true"><typo3-backend-icon icon="modulegroup-site" size="default"></typo3-backend-icon></span>
  ...
  private renderMenuLink(controller: string, label: string)
  {
    return html`
      <li data-level="1">
        <a href="install.php?install[controller]=${controller}"
          ...
          role="menuitem"
        >
          <span class="modulemenu-icon" aria-hidden="true"><typo3-backend-icon icon="module-install-${controller}" size="default"></typo3-backend-icon></span>
