...
export class Helper {
  public static dispatchFormEditor(requirements: ModuleRequirements, options: any): void {
    Promise.all([requirements.app, requirements.mediator, requirements.viewModel].map((module) => import(module + '.js'))).then((modules: [any, any, any]) =>
  ...
  public static dispatchFormManager(requirements: ModuleRequirements, options: any): void {
    Promise.all([requirements.app, requirements.viewModel].map((module) => import(module + '.js'))).then((modules: [any, any]) =>
