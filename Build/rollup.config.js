  ...
  plugins: [
    ...
    copy({
         targets: [
           ...
           { src: 'node_modules/lit-html/lit-html.js', dest: contribDir + '/lit-html', rename: (name, extension) => name + '.mjs' },
           {
             src: [
           ...
           { src: 'node_modules/lit-element/lit-element.js', dest: contribDir + '/lit-element', rename: (name, extension) => name + '.mjs' },
           {
             src: [
              ...
              dest: contribDir + '/lit-element/lib',
              rename: (name, extension) => name + '.mjs',
           },
           ...
           */
           ...
           {
             src: 'node_modules/sortablejs/dist/sortable.umd.js', dest: contribDir, rename: 'Sortable.mjs', transform: contents => UMDtoES6(contents.toString()),
           },
           {
