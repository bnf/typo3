...
module.exports = function (grunt) {
   ...
   * - 3) Minify build
   */
  grunt.registerTask('scripts', ['compile-typescript', 'processAndCopyJavaScript:ts']);
  ...
  grunt.task.registerMultiTask('processAndCopyJavaScript', function () {
