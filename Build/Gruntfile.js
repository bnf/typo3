...
module.exports = function (grunt) {
  ...
  grunt.initConfig({
    ...
    sass: {
      options: {
        implementation: {
          ...
          compileAsync(...args) {
            return require('sass').compileAsync(...args)
          },
        },
    ...
    exec: {
      ...
      rollup: ((process.platform === 'win32') ? 'node_modules\\.bin\\rollup.cmd' : process.argv[0] + ' ./node_modules/.bin/rollup') + ' -c rollup/config.js',
      'rollup-ckeditor': ((process.platform === 'win32') ? 'node_modules\\.bin\\rollup.cmd' : process.argv[0] + ' ./node_modules/.bin/rollup') + ' -c rollup/ckeditor.js',
    ...
    'process-javascript': {
      ts: {
        ...
        pathmap: srcpath => require('path')
          ...
          .replace(/^([^\/]+)\//, '$1/Resources/Public/JavaScript/'),
        banner: '/*\n' +
          ' * This file is part of the TYPO3 CMS project.\n' +
          ' *\n' +
          ' * It is free software; you can redistribute it and/or modify it under\n' +
        ...
        options: {
          ...
          copyOptions: {
            process: (source, srcpath) => {
              ...
              return require('./lib/cjs-to-esm.js').cjsToEsm(source, prefix);
            }
          }
        },
        files: {
    ...
    concurrent: {
      ...
      build: ['exec:rollup-ckeditor', 'scripts', 'css', 'thirdparty']
    },
  });
   ...
   */
  grunt.registerTask('thirdparty', ['clean', 'copy', 'npmcopy', 'terser:thirdparty', 'flags-build', 'exec:rollup']);
