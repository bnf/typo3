define(['jquery', '../../../../../../core/Resources/Public/TypeScript/Ajax/AjaxRequest', 'bootstrap', '../../../../../../core/Resources/Public/TypeScript/SecurityUtility', '../AbstractInteractableModule', '../../Renderable/Severity', '../../Renderable/InfoBox', '../../Renderable/ProgressBar', '../../Router', '../../Renderable/FlashMessage'], function ($, AjaxRequest, bootstrap, SecurityUtility, AbstractInteractableModule, Severity, InfoBox, ProgressBar, Router, FlashMessage) { 'use strict';
     ...
     */
    class LanguagePacks extends AbstractInteractableModule.AbstractInteractableModule {
        constructor() {
            super(...arguments);
