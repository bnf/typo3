define(['../../../../backend/Resources/Public/JavaScript/Enum/Severity', '../../../../core/Resources/Public/JavaScript/Contrib/jquery/jquery', '../../../../backend/Resources/Public/JavaScript/Modal'], function (Severity, jquery, Modal) { 'use strict';
            ...
            jquery(() => {
                jquery(document).on('click', '.t3js-filelist-delete', (e) => {
                    ...
                    if ($anchorElement.data('check')) {
                        const $modal = Modal.confirm($anchorElement.data('title'), $anchorElement.data('content'), Severity.SeverityEnum.warning, [
                            {
