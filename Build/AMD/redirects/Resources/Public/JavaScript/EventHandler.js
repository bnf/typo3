define(['../../../../core/Resources/Public/JavaScript/Ajax/AjaxRequest', '../../../../backend/Resources/Public/JavaScript/ActionButton/DeferredAction', '../../../../backend/Resources/Public/JavaScript/Notification'], function (AjaxRequest, DeferredAction, Notification) { 'use strict';
    ...
    class EventHandler {
        ...
        revert(correlationIds) {
            ...
            request.then(async (response) => {
                ...
                if (json.status === 'ok') {
                    Notification.success(json.title, json.message);
                }
                if (json.status === 'error') {
                    Notification.error(json.title, json.message);
                }
            }).catch(() => {
                Notification.error(TYPO3.lang.redirects_error_title, TYPO3.lang.redirects_error_message);
            });
            return request;
        }
    }
