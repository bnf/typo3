define(['../BackwardCompat/JQueryNativePromises', './AjaxResponse', './ResponseError', './InputTransformer'], function (JQueryNativePromises, AjaxResponse, ResponseError, InputTransformer) { 'use strict';
    ...
    class AjaxRequest {
        ...
        withQueryArguments(data) {
            ...
            clone.queryArguments = (clone.queryArguments !== '' ? '&' : '') + InputTransformer.InputTransformer.toSearchParams(data);
            return clone;
        }
        /**
        ...
        async get(init = {}) {
            ...
            return new AjaxResponse.AjaxResponse(response);
        }
        /**
        ...
        async post(data, init = {}) {
            const localDefaultOptions = {
                body: typeof data === 'string' ? data : InputTransformer.InputTransformer.byHeader(data, init === null || init === void 0 ? void 0 : init.headers),
                cache: 'no-cache',
                method: 'POST',
            };
            const response = await this.send(Object.assign(Object.assign({}, localDefaultOptions), init));
        ...
        async delete(data = {}, init = {}) {
            ...
            if (typeof data === 'object' && Object.keys(data).length > 0) {
                localDefaultOptions.body = InputTransformer.InputTransformer.byHeader(data, init === null || init === void 0 ? void 0 : init.headers);
            }
