define(function () { 'use strict';
    ...
    class WindowManager {
        constructor() {
            this.windows = {};
            // alias for `localOpen`
            this.open = (...args) => this.localOpen.apply(this, args);
            // @todo Not implemented, yet
            this.globalOpen = (...args) => this.localOpen.apply(this, args);
        }
        localOpen(uri, switchFocus, windowName = 'newTYPO3frontendWindow', windowFeatures = '') {
            if (!uri) {
                return null;
            }
            if (switchFocus === null) {
