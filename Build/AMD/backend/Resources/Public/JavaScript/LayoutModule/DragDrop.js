define(['../Icons', '../../../../../core/Resources/Public/JavaScript/Contrib/jquery/jquery', '../AjaxDataHandler', '../../../../../core/Resources/Public/JavaScript/Contrib/jquery-ui/droppable'], function (Icons, jquery, AjaxDataHandler, droppable) { 'use strict';
    ...
    class DragDrop {
         ...
         * @private
         */
        static onDropHoverOver($draggableElement, $droppableElement) {
         ...
         * @private
         */
        static onDropHoverOut($draggableElement, $droppableElement) {
        ...
        static onDrop($draggableElement, $droppableElement, evt) {
            ...
            if (typeof (contentElementUid) === 'number' && contentElementUid > 0) {
                ...
                if (typeof targetFound === 'undefined') {
                    ...
                    targetPid = parseInt(evt.target.offsetParent.getAttribute('data-page'), 10);
                }
                else {
                ...
                const copyAction = (evt && evt.originalEvent.ctrlKey || $droppableElement.hasClass('t3js-paste-copy'));
                if (copyAction) {
         ...
         */
        static getColumnPositionForElement($element) {
    ...
    DragDrop.dragIdentifier = '.t3-page-ce-dragitem';
