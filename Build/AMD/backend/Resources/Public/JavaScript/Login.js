define(['./Storage/Client', '../../../../core/Resources/Public/JavaScript/Contrib/jquery/jquery', '../../../../core/Resources/Public/JavaScript/Contrib/bootstrap', './Input/Clearable'], function (Client, jquery, bootstrap, Clearable) { 'use strict';
    ...
    class BackendLogin {
        ...
        checkDocumentReferrerSupport() {
            ...
            const loginUrlWrapper = document.getElementById(this.options.loginUrlWrapper);
