define(['./Icons', '../../../../core/Resources/Public/JavaScript/Contrib/jquery/jquery', './Severity', './Modal', './Utility/MessageUtility', './BackendException', './DocumentSaveActions', './Event/InteractionRequestMap', './FormEngineValidation'], function (Icons, jquery, Severity, Modal, MessageUtility, BackendException, DocumentSaveActions, InteractionRequestMap, FormEngineValidation) { 'use strict';
  ...
  */
    ...
    FormEngine.handlePostMessage = function (e) {
      if (!MessageUtility.MessageUtility.MessageUtility.verifyOrigin(e.origin)) {
    ...
    FormEngine.reinitialize = function() {
      ...
      if (clearables.length > 0) {
        window.require(['TYPO3/CMS/Backend/Input/Clearable'], function() {
