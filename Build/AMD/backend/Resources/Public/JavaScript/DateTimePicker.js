define(['require', '../../../../core/Resources/Public/JavaScript/Contrib/jquery/jquery', './Storage/Persistent', '../../../../core/Resources/Public/JavaScript/Contrib/moment'], function (require, jquery, Persistent, moment) { 'use strict';
    ...
    class DateTimePicker {
        ...
        initialize(selector) {
            ...
            if ($dateTimeFields.length > 0) {
                new Promise(function (resolve, reject) { require(['../../../../core/Resources/Public/JavaScript/Contrib/twbs/bootstrap-datetimepicker'], function (m) { resolve(/*#__PURE__*/_interopNamespaceDefaultOnly(m)); }, reject) }).then(() => {
