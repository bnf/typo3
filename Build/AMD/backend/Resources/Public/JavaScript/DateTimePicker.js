define(['require', '../../../../core/Resources/Public/JavaScript/Event/ThrottleEvent', '../../../../core/Resources/Public/JavaScript/DocumentService', './Storage/Persistent', '../../../../core/Resources/Public/JavaScript/Contrib/flatpickr/flatpickr.min', '../../../../core/Resources/Public/JavaScript/Contrib/moment'], function (require, ThrottleEvent, DocumentService, Persistent, flatpickr_min, moment) { 'use strict';
    ...
    class DateTimePicker {
        ...
        initialize(element) {
            ...
            dateTimePickers.forEach((inputElement) => {
                ...
                new Promise(function (resolve, reject) { require(['../../../../core/Resources/Public/JavaScript/Contrib/flatpickr/locales'], function (m) { resolve(/*#__PURE__*/_interopNamespaceDefaultOnly(m)); }, reject) }).then(() => {
        ...
        initializeField(inputElement, locale) {
            ...
            const dateTimePicker = flatpickr_min(inputElement, options);
