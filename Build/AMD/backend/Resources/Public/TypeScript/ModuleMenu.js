define(['require', './Enum/Viewport/ScaffoldIdentifier', './Event/ClientRequest', 'jquery', './Event/TriggerRequest', '../../../../core/Resources/Public/TypeScript/Ajax/AjaxRequest', '../../../../core/Resources/Public/TypeScript/Event/RegularEvent', './Viewport', './Storage/Persistent'], function (require, ScaffoldIdentifier, ClientRequest, $, TriggerRequest, AjaxRequest, RegularEvent, Viewport, Persistent) { 'use strict';
