define(['./Enum/Severity', 'jquery', '../../../../core/Resources/Public/TypeScript/Ajax/AjaxRequest', './Modal', './Notification', './InfoWindow', './Viewport', './AjaxDataHandler', './ModuleMenu'], function (Severity, $, AjaxRequest, Modal, Notification, InfoWindow, Viewport, AjaxDataHandler, ModuleMenu) { 'use strict';
