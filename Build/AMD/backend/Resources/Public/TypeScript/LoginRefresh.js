define(['require', 'jquery', '../../../../core/Resources/Public/TypeScript/Ajax/AjaxRequest', './Storage/Client', './Severity', './Modal', './Notification'], function (require, $, AjaxRequest, Client, Severity, Modal, Notification$1) { 'use strict';
