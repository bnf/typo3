define(['./Enum/Severity', 'jquery', '../../../../core/Resources/Public/TypeScript/Ajax/AjaxRequest', 'bootstrap', '../../../../core/Resources/Public/TypeScript/SecurityUtility', './Icons', './Severity'], function (Severity, $, AjaxRequest, bootstrap, SecurityUtility, Icons, Severity$1) { 'use strict';
    ...
    class Modal {
         ...
         * @returns {JQuery}
         */
        loadUrl(title, severity = Severity.SeverityEnum.info, buttons, url, callback, target) {
            return this.advanced({
                type: Types.ajax,
                title,
                severity,
         ...
         * @returns {JQuery}
         */
        show(title, content, severity = Severity.SeverityEnum.info, buttons, additionalCssClasses) {
            return this.advanced({
                type: Types.default,
                title,
                content,
        ...
        generate(configuration) {
            ...
            currentModal.addClass('modal-severity-' + Severity$1.getCssClass(configuration.severity));
