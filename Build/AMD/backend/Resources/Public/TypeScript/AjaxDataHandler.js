define(['./Enum/Severity', 'jquery', '../../../../core/Resources/Public/TypeScript/Ajax/AjaxRequest', './Icons', './Modal', './Notification', './BroadcastMessage', './BroadcastService', './Viewport'], function (Severity, $, AjaxRequest, Icons, Modal, Notification, BroadcastMessage, BroadcastService, Viewport) { 'use strict';
    ...
    class AjaxDataHandler {
        ...
        process(parameters, eventDict) {
            ...
            return promise.then((result) => {
                ...
                if (eventDict) {
                    ...
                    const message = new BroadcastMessage.BroadcastMessage('datahandler', 'process', payload);
        ...
        toggleRow($rowElement) {
            ...
            $anchorElement.tooltip('hide').one('hidden.bs.tooltip', () => {
