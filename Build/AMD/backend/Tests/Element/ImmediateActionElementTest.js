define(['../../Resources/Public/JavaScript/Viewport', '../../Resources/Public/JavaScript/ModuleMenu', '../../Resources/Public/JavaScript/Element/ImmediateActionElement'], function (Viewport, ModuleMenu, ImmediateActionElement) { 'use strict';
    ...
    describe('TYPO3/CMS/Backend/Element/ImmediateActionElement:', () => {
        ...
        it('dispatches action when created via constructor', () => {
            ...
            const element = new ImmediateActionElement.ImmediateActionElement;
        ...
        it('dispatches action when created from string', () => {
            const backup = ModuleMenu.App.refreshMenu;
            const observer = {
                callback: () => {
                    return;
                },
            ...
            spyOn(observer, 'callback').and.callThrough();
            ModuleMenu.App.refreshMenu = observer.callback;
            ...
            root.appendChild(element);
            expect(observer.callback).toHaveBeenCalled();
            ModuleMenu.App.refreshMenu = backup;
        });
