...
class FileLinkHandler extends AbstractLinkHandler implements LinkHandlerInterface, LinkParameterProviderInterface
{
    ...
    {
        $this->pageRenderer->loadJavaScriptModule('@typo3/recordlist/FileLinkHandler.js');
        $this->pageRenderer->loadJavaScriptModule('@typo3/backend/Viewport/ResizableNavigation.js');
        $this->pageRenderer->loadJavaScriptModule('@typo3/backend/Tree/FileStorageBrowser.js');
