...
if(e.innerHTML=n.html,t.setButtons(n.buttons),!0===n.success&&"object"==typeof n.status)for(const t of Object.values(n.status))for(const o of t)e.querySelector(i.outputContainer).append(r.create(o.severity,o.title,o.message))
