...
class UpgradeWizards extends AbstractInteractableModule {
    constructor() {
        ...
        this.selectorWizardsInputDescription = '.t3js-upgradeWizards-input-description';
        ...
        this.selectorWizardsInputAbort = '.t3js-upgradeWizards-input-abort';
    ...
    initialize(currentModal) {
        ...
        currentModal.on('click', this.selectorWizardsInputAbort, (e) => {
