...
(function (RecyclerIdentifiers) {
    ...
    RecyclerIdentifiers["undo"] = "a[data-action=undo]";
    RecyclerIdentifiers["delete"] = "a[data-action=delete]";
    RecyclerIdentifiers["massUndo"] = "button[data-multi-record-selection-action=massundo]";
    RecyclerIdentifiers["massDelete"] = "button[data-multi-record-selection-action=massdelete]";
    ...
    constructor() {
        ...
        this.handleCheckboxStateChanged = (e) => {
            ...
            if (this.markedRecordsForMassAction.length > 0) {
                this.elements.$massUndo.find('span.text').text(this.createMessage(TYPO3.lang['button.undoselected'], [this.markedRecordsForMassAction.length]));
                this.elements.$massDelete.find('span.text').text(this.createMessage(TYPO3.lang['button.deleteselected'], [this.markedRecordsForMassAction.length]));
            }
            else {
