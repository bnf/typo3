...
class RequestHandler implements RequestHandlerInterface
{
    ...
    protected function generatePageContent(TypoScriptFrontendController $controller, ServerRequestInterface $request): string
    {
        ...
        if ($controller->isINTincScript()) {
            ...
            $controller->config['INTincScript_ext']['pageRenderer'] = serialize($pageRenderer->getState());
            // Store the serialized AssetCollector in configuration
            $controller->config['INTincScript_ext']['assetCollector'] = serialize(GeneralUtility::makeInstance(AssetCollector::class)->getState());
