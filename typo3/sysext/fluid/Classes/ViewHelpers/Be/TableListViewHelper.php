...
final class TableListViewHelper extends AbstractBackendViewHelper
{
    ...
    public function render(): string
    {
        ...
        $this->getPageRenderer()->loadJavaScriptModule('@typo3/recordlist/RecordDownloadButton.js');
        $this->getPageRenderer()->loadJavaScriptModule('@typo3/backend/ActionDispatcher.js');
        if ($enableControlPanels === true) {
            $this->getPageRenderer()->loadJavaScriptModule('@typo3/backend/MultiRecordSelection.js');
            $this->getPageRenderer()->loadJavaScriptModule('@typo3/backend/ContextMenu.js');
        }
