...
if(r.innerHTML=o.errorMessage,o.errorCount>0){const e=n.confirm(o.errorTitle,r,s.error,[{text:TYPO3.lang["button.cancel"],active:!0,btnClass:"btn-default",trigger:()=>{n.dismiss()}},{text:TYPO3.lang["button.resolveDependenciesIgnore"],btnClass:"btn-danger disabled t3js-dependencies",trigger:e=>{e.currentTarget.classList.contains("disabled")||(this.getResolveDependenciesAndInstallResult(o.skipDependencyUri),n.dismiss())}}])
e.addEventListener("typo3-modal-shown",(()=>{const n=e.querySelector(".t3js-dependencies")
e.querySelector('input[name="unlockDependencyIgnoreButton"]').addEventListener("change",(e=>{e.currentTarget.checked?n?.classList.remove("disabled"):n?.classList.add("disabled")}))}))}else{let e=TYPO3.lang["extensionList.dependenciesResolveDownloadSuccess.message"+o.installationTypeLanguageKey].replace(/\{0\}/g,o.extension)
e+="\n"+TYPO3.lang["extensionList.dependenciesResolveDownloadSuccess.header"]+": "
for(const[n,t]of Object.entries(o.result)){e+="\n\n"+TYPO3.lang["extensionList.dependenciesResolveDownloadSuccess.item"]+" "+n+": "
for(const n of Object.keys(t))e+="\n* "+n}t.info(TYPO3.lang["extensionList.dependenciesResolveFlashMessage.title"+o.installationTypeLanguageKey].replace(/\{0\}/g,o.extension),e,15),top.TYPO3.ModuleMenu.App.refreshMenu()}}catch{t.error(TYPO3.lang["extensionList.dependenciesResolveInstallError.title"]||"Install error",TYPO3.lang["extensionList.dependenciesResolveInstallError.message"]||"Your installation failed while resolving dependencies.")}}),(()=>{t.error(TYPO3.lang["extensionList.dependenciesResolveInstallError.title"]||"Install error",TYPO3.lang["extensionList.dependenciesResolveInstallError.message"]||"Your installation failed while resolving dependencies.")})).finally((()=>{e.done()}))}bindSearchFieldResetter(){let e
