    ...
    protected function getComposerManifestMarkup(string $extensionKey): string
    {
        ...
        if (ExtensionManagementUtility::isLoaded('t3editor')) {
            ...
            $codeMirrorConfig = [
                ...
                'panel' => 'bottom',
                'mode' => json_encode(JavaScriptModuleInstruction::create('@codemirror/lang-json', 'json')->invoke()),
                'nolazyload' => 'true',
                'autoheight' => 'true',
            ...
            return '<typo3-t3editor-codemirror ' . GeneralUtility::implodeAttributes($codeMirrorConfig, true) . '>'
                . '<textarea class="form-control">' . htmlspecialchars($composerManifest) . '</textarea>'
