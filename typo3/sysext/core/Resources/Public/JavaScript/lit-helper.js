 ...
 */
import{html as e,render as t,nothing as n}from"lit"
import{until as r}from"lit/directives/until.js"
export const renderNodes=e=>{const n=document.createElement("div")
return t(e,n),n.childNodes}
export const renderHTML=e=>{const n=document.createElement("div")
return t(e,n),n.innerHTML}
export const lll=(e,...t)=>{if(!window.TYPO3||!window.TYPO3.lang||"string"!=typeof window.TYPO3.lang[e])return""
let n=0
return window.TYPO3.lang[e].replace(/%[sdf]/g,(e=>{const r=t[n++]
