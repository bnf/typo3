...
class Bootstrap
{
    ...
    public static function init(
        ...
        // Cleaup a previous container instance as it must not be used make makeInstance
        // when creating early instances.
        // This is only required for functional tests. @todo move into testing framework
