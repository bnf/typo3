...
class ContainerBuilder
{
    ...
    public function warmupCache()
    {
        ...
        $this->buildContainer([$serviceProviderBundle], $this->defaultServices);
    }
    ...
    public function createDependencyInjectionContainer(array $defaultEntries): ContainerInterface
    {
        ...
        if ($this->cache->has($cacheIdentifier)) {
            ...
            $code = $this->buildContainer($bundles, array_keys($defaultEntries));
     ...
     * @return string
     */
    protected function buildContainer(array $bundles, array $defaultEntries): string
    {
        $cacheIdentifier = $this->getCacheIdentifier();
        $containerClassName = $cacheIdentifier;
