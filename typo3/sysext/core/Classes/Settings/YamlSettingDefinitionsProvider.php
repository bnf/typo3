...
class YamlSettingDefinitionsProvider
{
    public function __construct(
        private SettingsDefinitionsCollection $settingsDefinitionsCollection,
    ) {}
    ...
    public function loadSettingsDefinitions(string $path)
    {
        ...
        $this->settingsDefinitionsCollection->parseCategoryDefinitions($categories);
        $this->settingsDefinitionsCollection->parseDefinitions($definitions, 'system');
    }
}
