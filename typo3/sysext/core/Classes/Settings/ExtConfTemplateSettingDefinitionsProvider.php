...
final class ExtConfTemplateSettingDefinitionsProvider
{
    ...
    public function loadExtConfTemplateTxt(SettingsRegistry $settingsRegistry): void
    {
        ...
        $settingsRegistry->addCategoryDefinitions(...$categoryDefinitions);
        array_map(static fn($definition) => $settingsRegistry->addDefinition('system', $definition), $definitions);
    }
