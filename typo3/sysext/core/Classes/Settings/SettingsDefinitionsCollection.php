 ...
 * @internal
 */
class SettingsDefinitionsCollection
{
    ...
    public function parseDefinitions(array $definitions, string $group): void
    {
        foreach ($definitions['settings'] ?? [] as $setting => $options) {
            try {
            ...
            $this->addDefinition($group, $definition);
        }
    }
    ...
    public static function __set_state(array $state): self
    {
        ...
        $self->categoryDefinitions = $state['categoryDefinitions'];
        return $self;
    }
}
