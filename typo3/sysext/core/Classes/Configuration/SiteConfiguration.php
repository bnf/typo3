...
class SiteConfiguration implements SingletonInterface
{
    ...
    /**
     * File naming containing TypoScript Dependencies.
     *
     * @internal
     */
    protected string $typoScriptDependenciesFileName = 'typoscript.dependencies';
    ...
    protected function getSiteTypoScript(string $siteIdentifier): ?SiteTypoScript
    {
        $data = [
            ...
            'dependencies' => $this->typoScriptDependenciesFileName,
        ];
        $definitions = [];
