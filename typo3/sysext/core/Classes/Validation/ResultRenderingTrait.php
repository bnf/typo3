...
trait ResultRenderingTrait
{
     ...
     * @return list<string>
     */
    public function compileResultMessages(array $messages, ?TranslatorInterface $tanslator = null): array
    {
        return array_map(
            static fn(ResultMessage $message): string => $message->labelBag !== null && $tanslator !== null
                ? $message->labelBag->compile($tanslator)
                : $message->message,
            $messages
        );
    }
