...
class ImportMap
{
    ...
    public function render(string $sitePath, string $nonce, bool $includePolyfill = true): string
    {
        ...
        $importMap = $this->composeImportMap($sitePath);
        $json = json_encode(
            $importMap,
    ...
    protected function composeImportMap(string $sitePath): array
    {
