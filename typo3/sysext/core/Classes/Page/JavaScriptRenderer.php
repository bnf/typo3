...
class JavaScriptRenderer
{
    ...
    public function render(null|string|ConsumableNonce $nonce = null, ?string $sitePath = null): string
    {
        ...
        if ($sitePath !== null &&
            ...
            foreach ($globalAssignments as $data) {
                $scriptTags[] = $this->createScriptElement(
                    ['nonce' => (string)$nonce],
                    sprintf('Object.assign(globalThis, %s)', json_encode($data['payload'])),
                );
            }
    ...
    public function renderImportMap(string $sitePath, null|string|ConsumableNonce $nonce = null, ?Policy $csp = null): string
    {
