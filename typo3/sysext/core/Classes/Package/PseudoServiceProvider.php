...
final class PseudoServiceProvider extends AbstractServiceProvider
{
    ...
    public function getExtensions(): array
    {
        ...
        // dynamically inject the package path to service
        // extensions.
        // AbstractServiceProvider methods are aware of that and provider an
        // optional thrid parameter which is used if the PATH constant is
        // unset.
        foreach ($extensions as $serviceName => $previousCallable) {
            //if (substr($serviceName, 0, 9) !== 'configure') {
            //    continue;
            //}
