...
===============================================
Feature: #90197 - Introduce cache:flush command
===============================================
...
It is now possible to flushp TYPO3 caches using the command line.
...
may decide to flush all caches (common practive with `EXT:typo3_console`) or
may alternativly flush selected groups (e.g. 'pages') in case the `cache:warmup`
