...
=======================================================================
Breaking: #96939 - Introduce Fluid Styled Content CSS custom properties
=======================================================================
...
content element is present. The default styling now also makes use of CSS custom
properties (also called CSS variables).
