...
======================================================================
Feature: #96939 - Introduce Fluid Styled Content CSS custom properties
======================================================================
...
styling options as CSS custom properties (also called CSS variables) in the
frontend:
...
These should create separate CSS files with the same name. For example
...
CSS custom properties for its styling options. Stylesheets are added by the
