...
final class SitemapXmlCest
{
    public function _before(ApplicationTester $I, PageTree $pageTree)
    {
        ...
        $I->waitForElementVisible('typo3-backend-module > [slot="docheader-button-left"] a:first-child');
        $I->wait(1);
        $I->waitForElementNotVisible('#nprogress', 120);
        $dataDispatchArgs = $I->grabAttributeFrom('typo3-backend-module > [slot="docheader-button-left"] a:first-child', 'data-dispatch-args');
