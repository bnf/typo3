    ...
    public static function getDatetimeSets(): array
    {
        return [
            ...
            'empty string to null on Europe/Berlin' => [
                // @todo ResultNull and ResultEmpty are not equal and can be merged (delayed for the sake of the diff)
                'resultSet' => 'ResultEmpty',
                'timezone' => 'Europe/Berlin',
                'datetime' => '',
                'date' => '',
    ...
    public static function getDatetimeObjectSets(): array
    {
        return [
            ...
            'null to null on UTC' => [
                ...
                'timesec' => null,
                'time' => null,
                'comment' => '@todo: Fix time*_native fields to be NULL instead of 00:00',
            ],
            'null to null on Europe/Berlin' => [
                'resultSet' => 'ResultNull',
                'timezone' => 'Europe/Berlin',
