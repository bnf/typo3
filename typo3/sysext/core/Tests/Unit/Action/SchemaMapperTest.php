...
final class SchemaMapperTest extends UnitTestCase
{
    #[DataProvider('types')]
    #[Test]
    public function canMap(Type $type, object $expected): void
    {
        $schemaMapper = new SchemaMapper();
        $value = $schemaMapper->map($type);
        self::assertEquals($expected, $value->getSerializableData());
    }
