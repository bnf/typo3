...
final class SchemaBuilderTest extends UnitTestCase
{
    ...
    public static function types(): \Generator
    {
        ...
        yield 'object with datetime property' => [
            Type::object(DateTimePropertyFixture::class),
            (object)[
                'description' => '`TYPO3\CMS\Core\Tests\Unit\JsonSchema\Fixtures\Schema\DateTimePropertyFixture`',
                '$ref' => '#/$defs/TYPO3.CMS.Core.Tests.Unit.JsonSchema.Fixtures.Schema.DateTimePropertyFixture',
                '$defs' => (object)[
                    'TYPO3.CMS.Core.Tests.Unit.JsonSchema.Fixtures.Schema.DateTimePropertyFixture' => (object)[
                        'type' => 'object',
                        'properties' => (object)[
                            'propertyA' => (object)['type' => 'string'],
                            'date' => (object)[
                                'type' => 'string',
                                'format' => 'date-time',
                                'x-typo3-type' => \DateTimeImmutable::class,
                            ],
                        ],
                        'required' => ['propertyA', 'date'],
                        'additionalProperties' => false,
                        'title' => DateTimePropertyFixture::class,
