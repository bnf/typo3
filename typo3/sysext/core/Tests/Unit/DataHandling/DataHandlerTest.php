...
use TYPO3\CMS\Core\DataHandling\DateTimeTransformer;
...
final class DataHandlerTest extends UnitTestCase
{
    ...
    public function checkValuePasswordWithSaltedPasswordDispatchesEvent(): void
    {
        ...
        $constructorArguments = [
            ...
            new OpcodeCacheService(),
            $this->createMock(FlashMessageService::class),
            $this->createMock(DateTimeTransformer::class),
        ];
    ...
    public static function inputValueRangeCheckIsIgnoredWhenDefaultIsZeroAndInputValueIsEmptyDataProvider(): array
    {
        return [
            ...
            'Zero (unix timestamp) returns zero as timestamp and unix-startdate as native value string' => [
                0,
                0,
                '1970-01-01 00:00:00',
            ],
            'Zero (unix timestamp) as a string returns zero as timestamp and unix-startdate as native value string' => [
                '0',
                0,
                '1970-01-01 00:00:00',
            ],
