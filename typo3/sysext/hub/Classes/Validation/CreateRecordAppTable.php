...
namespace TYPO3\CMS\Hub\Validation;
...
/**
 * Validation class for tables to be allowed for record creation in the "create record" app
 *
 * @internal
 */
final readonly class CreateRecordAppTable
{
    public function __construct(private string $table) {}

    public static function fromSelectItem(SelectItem $selectItem): CreateRecordAppTable
    {
    ...
    {
        $schema = GeneralUtility::makeInstance(TcaSchemaFactory::class)->get('sys_app');
