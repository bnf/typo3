...
class ManagementController
{
            ...
            'actions' => [
                ...
                new Action(
                    ...
                    [
                        'idField' => 'uid',
                        'tableName' => 'sys_app',
                        'title' => $languageService->sL('LLL:EXT:hub/Resources/Private/Language/Modules/hub.xlf:labels.delete.title'),
                        'content' => $languageService->sL('LLL:EXT:hub/Resources/Private/Language/Modules/hub.xlf:labels.delete.message'),
    ...
    protected function registerDocHeaderButtons(ModuleTemplate $view, string $requestUri, AppDemand $demand): void
    {
        ...
        $shortcutButton = $this->componentFactory->createShortcutButton()
            ->setRouteIdentifier('integrations_hub')
            ->setDisplayName($languageService->sL('LLL:EXT:hub/Resources/Private/Language/Modules/hub.xlf:title'))
