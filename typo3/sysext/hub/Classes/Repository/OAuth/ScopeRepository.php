...
final readonly class ScopeRepository implements ScopeRepositoryInterface
{
    ...
    public function getScopeByIdentifier(string $identifier): ?Scope
    {
        ...
        return Scope::create($this->scopeRegistry->get($identifier));
    }
    ...
    public function finalizeScopes(
        ...
        if ($userIdentifier !== null) {
            ...
            if (($GLOBALS['BE_USER']->user['uid'] ?? null) === $id) {
                ...
                //throw new \RuntimeException('finalizing scopes for another user is not implemented.', 1772203587);
                $beuser = GeneralUtility::makeInstance(BackendUserAuthentication::class);
                $beuser->setBeUserByUid($id);
                // @todo check
            }
