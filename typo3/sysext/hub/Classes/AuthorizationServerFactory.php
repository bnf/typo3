...
use TYPO3\CMS\Hub\Repository\AuthCodeRepository;
use TYPO3\CMS\Hub\Repository\ClientRepository;
use TYPO3\CMS\Hub\Repository\RefreshTokenRepository;
...
final readonly class AuthorizationServerFactory
{
    ...
    public function createAuthorizationServer(): AuthorizationServer
    {
        $server = new AuthorizationServer(
            ...
            // Set a dummy crypt key instance, since we use symmetric JWT
            // (real JWT encoding is handled in TYPO3\CMS\Hub\Model\AccessToken)
            new CryptKey(),
