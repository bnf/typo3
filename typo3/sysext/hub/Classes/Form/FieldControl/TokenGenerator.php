...
namespace TYPO3\CMS\Hub\Form\FieldControl;
...
/**
 * Renders a widget to generate an app token secret and a corresponding JWT in JavaScript.
 *
 * @internal
 */
class TokenGenerator extends AbstractNode
{
    public function render(): array
    {
        ...
        return [
            ...
            'javaScriptModules' => [
                JavaScriptModuleInstruction::create('@typo3/hub/form-engine/field-control/token-generator.js')->instance($id),
            ],
        ];
    }
}
