...
..  code-block:: bash
    ...
    composer show | grep hub

This should either give you no result or something similar to:

..  code-block:: none

    typo3/cms-hub       v12.4.11
...
..  code-block:: bash
    ...
    composer require typo3/cms-hub
...
#.  In the backend, navigate to the :guilabel:`Admin Tools > Extensions`
    module.
#.  Click the :guilabel:`Activate` icon for the Hub extension.

..  figure:: /Images/InstallActivate.png
    :class: with-border
    :alt: Extension manager showing Hub extension

    Extension manager showing Hub extension
