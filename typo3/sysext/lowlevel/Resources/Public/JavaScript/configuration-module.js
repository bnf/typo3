...
var __decorate=function(e,t,o,a){var r,i=arguments.length,l=i<3?t:null===a?a=Object.getOwnPropertyDescriptor(t,o):a;if("object"==typeof Reflect&&"function"==typeof Reflect.decorate)l=Reflect.decorate(e,t,o,a);else for(var n=e.length-1;n>=0;n--)(r=e[n])&&(l=(i<3?r(l):i>3?r(t,o,l):r(t,o))||l);return i>3&&l&&Object.defineProperty(t,o,l),l};import{html,css,LitElement}from"lit";import{customElement,property,state}from"lit/decorators.js";import{ifDefined}from"lit/directives/if-defined.js";import{live}from"lit/directives/live.js";import{repeat}from"lit/directives/repeat.js";import AjaxRequest from"@typo3/core/ajax/ajax-request.js";import Loader from"@typo3/backend/viewport/loader.js";import"@typo3/backend/element/module.js";import"@typo3/backend/element/icon-element.js";import"@typo3/backend/element/spinner-element.js";export const componentName="typo3-lowlevel-configuration-module";const alwaysUpdate=()=>!0;let ConfigurationModule=class extends LitElement{constructor(){super(...arguments),this.endpoint="",this.search="",this.regex=!1,this.active=!1,this.data=null,this.loading=!1,this.load=!1}createRenderRoot(){return this}render(){return null!==this.data&&!this.load||this.loading||this.loadData(),html`
    ...
    `}shouldUpdate(){return this.active}updated(e){const t=this.endpoint,o="system_config";console.log("config updated",e);let a=!1;if(e.forEach(((e,r)=>{if("active"===r&&!0!==e&&(this.load=!0,a=!0),"endpoint"===r&&(this.load=!0,a=!0),"loading"===r&&!0!==e&&Loader.start(),"loading"===r&&!0===e){Loader.finish();const e=new CustomEvent("typo3-module-loaded",{bubbles:!0,composed:!0,detail:{url:t,module:o,title:this.data?`${this.data.labels.configuration}: ${this.data.treeName}`:void 0}});console.log("sending out config module loaded "+t),this.dispatchEvent(e)}})),a){const e=new CustomEvent("typo3-module-load",{bubbles:!0,composed:!0,detail:{url:t,module:o}});this.dispatchEvent(e)}}async loadData(){let e=this.endpoint;this.search&&(e+="&searchString="+encodeURIComponent(this.search)+"&regexSearch="+(this.regex?1:0)),console.log("loadData",e),this.loading=!0;const t=await new AjaxRequest(e).get({cache:"no-cache"}),o=await t.resolve();this.loading=!1,this.load=!1,this.data=o}createShortcut(e){return top.TYPO3.ShortcutMenu.createShortcut(e.shortcut.routeIdentifier,e.shortcut.routeArguments,e.shortcut.displayName,"Create a bookmark to this page",this.renderRoot.querySelector("#shortcut-button")),!1}renderData(){const e=this.data,t=this.data.labels;return html`
      <span slot="docheader">
    ...
    `}renderElement(e){return html`
      <li class="${e.active?"active":""}">
        <span class="list-tree-group">
          ${e.expandable?html`
            <a class="list-tree-control ${e.expanded?"list-tree-control-open":"list-tree-control-closed"}" id="${e.id}" href="${e.toggle}" @click="${this._linkClick}">
              <typo3-backend-icon identifier="${e.expanded?"actions-caret-down":"actions-caret-right"}" size="small"></typo3-backend-icon>
            </a>`:""}
    ...
    `}_linkClick(e){e.preventDefault();const t=e.currentTarget.getAttribute("href");console.log("setting endpoint to ",t),this.endpoint=t,this.removeAttribute("search"),this.removeAttribute("regex")}};ConfigurationModule.styles=css`
    :host {
      display: block;
      height: 100%;
    }
