 ...
 */
var __decorate=this&&this.__decorate||function(t,e,s,o){var a,c=arguments.length,l=c<3?e:null===o?o=Object.getOwnPropertyDescriptor(e,s):o;if("object"==typeof Reflect&&"function"==typeof Reflect.decorate)l=Reflect.decorate(t,e,s,o);else for(var r=t.length-1;r>=0;r--)(a=t[r])&&(l=(c<3?a(l):c>3?a(e,s,l):a(e,s))||l);return c>3&&l&&Object.defineProperty(e,s,l),l};define(["require","exports","lit-element","TYPO3/CMS/Backend/BroadcastMessage","TYPO3/CMS/Backend/BroadcastService"],(function(t,e,s,o,a){"use strict";Object.defineProperty(e,"__esModule",{value:!0}),e.ConfigurationModule=void 0;let c=class extends s.LitElement{static get styles(){return s.css`
      :host {
        display: block;
        height: 100%;
      }
...
<svg class="icon-color" role="img"><use xlink:href="/typo3/sysext/core/Resources/Public/Icons/T3Icons/sprites/actions.svg#actions-star"></use></svg>
    ...
    `}firstUpdated(){const t=new CustomEvent("typo3-module-loaded",{detail:{message:"Something important happened"}});this.dispatchEvent(t);const e="/typo3/module/system/config?token=dummy",s=new o.BroadcastMessage("navigation","contentchange",{url:e,module:"system_config"});console.log("sending out an url change "+e),a.post(s,!0)}};c=__decorate([s.customElement("typo3-lowlevel-configuration-module")],c),e.ConfigurationModule=c}));