...
<svg class="icon-color" role="img"><use xlink:href="/typo3/sysext/core/Resources/Public/Icons/T3Icons/sprites/actions.svg#actions-star"></use></svg>
    ...
    `}connectedCallback(){super.connectedCallback();const t="/typo3/module/system/config?token=dummy",e=new CustomEvent("typo3-module-load",{bubbles:!0,composed:!0,detail:{url:t,decorate:!1}});console.log("sending out config module load "+t),this.dispatchEvent(e)}firstUpdated(){const t="/typo3/module/system/config?token=dummy",e=new CustomEvent("typo3-module-loaded",{bubbles:!0,composed:!0,detail:{url:t,module:"system_config"}});console.log("sending out config module loaded "+t),this.dispatchEvent(e)}};o=__decorate([s.customElement("typo3-lowlevel-configuration-module")],o),e.ConfigurationModule=o}));