...
var __decorate=this&&this.__decorate||function(e,t,o,r){var a,l=arguments.length,i=l<3?t:null===r?r=Object.getOwnPropertyDescriptor(t,o):r;if("object"==typeof Reflect&&"function"==typeof Reflect.decorate)i=Reflect.decorate(e,t,o,r);else for(var s=e.length-1;s>=0;s--)(a=e[s])&&(i=(l<3?a(i):l>3?a(t,o,i):a(t,o))||i);return l>3&&i&&Object.defineProperty(t,o,i),i};define(["require","exports","lit-element","lit-html/directives/if-defined","lit-html/directives/repeat","TYPO3/CMS/Core/lit-helper","TYPO3/CMS/Core/Ajax/AjaxRequest","TYPO3/CMS/Backend/Element/Module","TYPO3/CMS/Backend/Element/SpinnerElement"],(function(e,t,o,r,a,l,i){"use strict";Object.defineProperty(t,"__esModule",{value:!0}),t.ConfigurationModule=void 0;let s=class extends o.LitElement{constructor(){super(...arguments),this.src="",this.search="",this.regex=!1,this.active=!1,this.data=null,this.loading=!1}static get styles(){return o.css`
    ...
    `:(this.loadData(),o.html`
        <typo3-backend-module>
          <typo3-backend-spinner slot="docheader-button-left"></typo3-backend-spinner>
        </typo3-backend-module>
      `)}connectedCallback(){super.connectedCallback();const e=this.src;if(this.active){const t=new CustomEvent("typo3-module-load",{bubbles:!0,composed:!0,detail:{module:"system_config",url:e,decorate:!1}});console.log("sending out config module load "+e),this.dispatchEvent(t)}this.addEventListener("click",e=>{if(console.log("click",e),e.defaultPrevented||0!==e.button||e.metaKey||e.ctrlKey||e.shiftKey)return;const t=e.composedPath().filter(e=>"A"===e.tagName)[0];if(!t||t.target||t.hasAttribute("download")||"external"===t.getAttribute("rel"))return;const o=t.href;o&&-1===o.indexOf("mailto:")&&(e.preventDefault(),this.setAttribute("src",o),this.removeAttribute("search"),this.removeAttribute("regex"))}),this.loadData()}attributeChangedCallback(e,t,o){super.attributeChangedCallback(e,t,o),"active"!==e&&this.active&&(this.requestUpdate(),this.updateComplete.then(()=>this.loadData()))}shouldUpdate(e){return e.forEach((e,t)=>{"active"===t&&!0===e&&(this.data=null)}),this.active}updated(e){const t=this.src;e.forEach((e,o)=>{if("active"===o&&!1===e){const e=new CustomEvent("typo3-module-load",{bubbles:!0,composed:!0,detail:{module:"system_config",url:t,decorate:!1}});console.log("sending out config module load, because of active attr "+this.getAttribute("src")),this.dispatchEvent(e)}if("loading"===o&&!0===e){const e=new CustomEvent("typo3-module-loaded",{bubbles:!0,composed:!0,detail:{url:t,module:"system_config"}});console.log("sending out config module loaded "+t),this.dispatchEvent(e)}})}async loadData(){if(this.loading)return Promise.reject();let e=this.src;this.search&&(e+="&searchString="+encodeURIComponent(this.search)+"&regexSearch="+(this.regex?1:0)),this.loading=!0;const t=await new i(e).get({cache:"no-cache"}),o=await t.resolve();this.loading=!1,this.data=o}renderData(){const e=this.data;return o.html`
      <span slot="docheader">
    ...
    `}};__decorate([o.property({type:String})],s.prototype,"src",void 0),__decorate([o.property({type:String})],s.prototype,"search",void 0),__decorate([o.property({type:Boolean})],s.prototype,"regex",void 0),__decorate([o.property({type:Boolean})],s.prototype,"active",void 0),__decorate([o.internalProperty()],s.prototype,"data",void 0),__decorate([o.internalProperty()],s.prototype,"loading",void 0),s=__decorate([o.customElement("typo3-lowlevel-configuration-module")],s),t.ConfigurationModule=s}));