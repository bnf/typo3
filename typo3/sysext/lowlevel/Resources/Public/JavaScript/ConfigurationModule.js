 ...
 */
var __decorate=this&&this.__decorate||function(e,t,o,a){var r,i=arguments.length,l=i<3?t:null===a?a=Object.getOwnPropertyDescriptor(t,o):a;if("object"==typeof Reflect&&"function"==typeof Reflect.decorate)l=Reflect.decorate(e,t,o,a);else for(var n=e.length-1;n>=0;n--)(r=e[n])&&(l=(i<3?r(l):i>3?r(t,o,l):r(t,o))||l);return i>3&&l&&Object.defineProperty(t,o,l),l};define(["require","exports","lit","lit/decorators","lit/directives/if-defined","lit/directives/live","lit/directives/repeat","TYPO3/CMS/Core/Ajax/AjaxRequest","TYPO3/CMS/Backend/Viewport/Loader","TYPO3/CMS/Backend/Element/Module","TYPO3/CMS/Backend/Element/ButtonElement","TYPO3/CMS/Backend/Element/IconElement","TYPO3/CMS/Backend/Element/SpinnerElement"],(function(e,t,o,a,r,i,l,n,s){"use strict";Object.defineProperty(t,"__esModule",{value:!0}),t.ConfigurationModule=t.componentName=void 0,t.componentName="typo3-lowlevel-configuration-module";let c=class extends o.LitElement{constructor(){super(...arguments),this.endpoint="",this.search="",this.regex=!1,this.active=!1,this.data=null,this.loading=!1,this.load=!1}createRenderRoot(){return this}render(){return null!==this.data&&!this.load||this.loading||this.loadData(),this.data?o.html`
    ...
    `:o.html`
      ...
      `}shouldUpdate(){return this.active}updated(e){const t=this.endpoint;console.log("config updated",e);let o=!1;if(e.forEach((e,a)=>{if("active"===a&&!0!==e&&(this.load=!0,o=!0),"endpoint"===a&&(this.load=!0,o=!0),"loading"===a&&!0!==e&&s.start(),"loading"===a&&!0===e){s.finish();const e=new CustomEvent("typo3-module-loaded",{bubbles:!0,composed:!0,detail:{url:t,module:"system_config",title:this.data?`${this.data.labels.configuration}: ${this.data.treeName}`:void 0}});console.log("sending out config module loaded "+t),this.dispatchEvent(e)}}),o){const e=new CustomEvent("typo3-module-load",{bubbles:!0,composed:!0,detail:{url:t,module:"system_config"}});this.dispatchEvent(e)}}async loadData(){let e=this.endpoint;this.search&&(e+="&searchString="+encodeURIComponent(this.search)+"&regexSearch="+(this.regex?1:0)),this.loading=!0;const t=await new n(e).get({cache:"no-cache"}),o=await t.resolve();this.loading=!1,this.load=!1,this.data=o}createShortcut(e){return top.TYPO3.ShortcutMenu.createShortcut(e.shortcut.routeIdentifier,e.shortcut.routeArguments,e.shortcut.displayName,"Create a bookmark to this page",this.renderRoot.querySelector("#shortcut-button")),!1}renderData(){const e=this.data,t=this.data.labels;return o.html`
      <span slot="docheader">
        <select .value="${i.live(e.self)}"
                @change="${({target:e})=>this.endpoint=e.options[e.selectedIndex].value}">
          ${l.repeat(e.items,e=>e.url,e=>o.html`<option value="${e.url}">${e.label}</option>`)}
        </select>
      </span>
