...
class ConfigurationController
{
    ...
    public function mainAction(ServerRequestInterface $request): ResponseInterface
    {
        ...
        if ($selectedTreeDetails['type'] === 'global') {
            ...
            // @todo: naming is hard. Rather show this in a separate view?
            $renderArray['unprocessed_original_configuration_including_dependency_definitions'] = $this->container->get('middlewares');
