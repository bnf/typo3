...
var r
!function(e){e.hidden="hidden",e.connect="connect",e.line="line",e.last="last"}(r||(r={}))
const o={domElementClassNames:{collapsed:"collapsed",expanded:"expanded",hasChildren:"has-children",sortable:"sortable",noNesting:"no-nesting"},domElementDataAttributeNames:{abstractType:"data-element-abstract-type"},domElementDataAttributeValues:{collapse:"actions-chevron-right",expander:"treeExpander",title:"treeTitle"},isSortable:!0}
let l=null,a=null,s=null
const m={}
function d(){return a}function c(e){return f().isUndefinedOrNull(e)?t.setConfiguration(l):t.setConfiguration(e)}function f(){return d().getUtility()}function p(e,t,n){return d().assert(e,t,n)}function u(){return d().getRootFormElement()}function g(){return d().getCurrentlySelectedFormElement()}function h(){return d().getPublisherSubscriber()}function b(e,t){return d().getFormElementDefinition(e,t)}function E(e){const t=document.createElement("span")
return t.classList.add("formeditor-tree-line","formeditor-tree-line--"+e),t}function D(t,i,o){p("object"===e.type(t),'Invalid parameter "formElement"',1478715704)
const l=e("<li></li>")
b(t,"_isCompositeFormElement")||l.addClass(c().getDomElementClassName("noNesting"))
const a=e("<div></div>").addClass("formeditor-tree-item").attr(c().getDomElementDataAttribute("elementIdentifier"),t.get("__identifierPath")).append(e("<span></span>").addClass("formeditor-tree-title").attr(c().getDomElementDataAttribute("identifier"),c().getDomElementDataAttributeValue("title")).append(buildTitleByFormElement(t)))
b(t,"_isCompositeFormElement")&&a.attr(c().getDomElementDataAttribute("abstractType"),"isCompositeFormElement"),b(t,"_isTopLevelFormElement")&&a.attr(c().getDomElementDataAttribute("abstractType"),"isTopLevelFormElement")
const s=document.createElement("span")
s.classList.add("caret")
const m=e("<span></span>").addClass("formeditor-tree-expander").attr("data-identifier",c().getDomElementDataAttributeValue("expander")).append(s)
a.prepend(m),n.getIcon(b(t,"iconIdentifier"),n.sizes.small,null,n.states.default).then((function(n){m.after(e("<span></span>").addClass("formeditor-tree-icon").addClass(c().getDomElementClassName("icon")).attr("title","id = "+t.get("identifier")).append(n)),b(t,"_isCompositeFormElement")?t.get("renderables")&&t.get("renderables").length>0?(m.before(E(i!=o?r.connect:r.last)),l.addClass(c().getDomElementClassName("hasChildren"))):m.before(E(r.connect)).remove():(a.prepend(E(i!=o?r.connect:r.last)),m.remove())
let s=t.get("__parentRenderable")
for(;s&&s.get("__identifierPath")!==u().get("__identifierPath");)s.get("__identifierPath")===d().getLastFormElementWithinParentFormElement(s).get("__identifierPath")?a.prepend(E(r.hidden)):a.prepend(E(r.line)),s=s.get("__parentRenderable")})),l.append(a),h().publish("view/tree/render/listItemAdded",[l,t])
...
new i(n,{...t,group:"tree-step-nodes",put:["tree-step-nodes"]}),n.querySelectorAll("ol").forEach((function(e){new i(e,{...t,group:"tree-leaves-nodes",pull:["tree-leaves-nodes"]})}))}(),function(){for(const e of Object.keys(m)){const t=getTreeNode(e)
...
return i.textContent="("+b(t,"label")+")",n.appendChild(i),n}export function getTreeDomElement(){return s}export function bootstrap(n,i,r){return a=n,p("object"===e.type(i),'Invalid parameter "appendToDomElement"',1478714814),s=e(i),l=e.extend(!0,o,r||{}),t.bootstrap(a),this}