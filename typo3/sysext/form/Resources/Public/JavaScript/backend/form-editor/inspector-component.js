...
""===t&&(t=o)
a.push({_label:o,_value:t})})),g().set(n+r,a),C(n+r,t)}function P(t){return e(c().getDomElementDataIdentifierSelector("editorWrapper"),e(t))}function S(t){return e(c().getDomElementDataIdentifierSelector("editorControlsWrapper"),e(t))}function C(e,t){let o,r,n
n=s().validateCurrentlySelectedFormElementProperty(e),n.length>0?(c().getTemplatePropertyDomElement("validationErrors",t).html('<span class="text-danger">'+n[0]+"</span>"),m().setElementValidationErrorClass(S(t),"hasError")):(c().getTemplatePropertyDomElement("validationErrors",t).html(""),m().removeElementValidationErrorClass(S(t),"hasError")),n=s().validateFormElement(g()),r=e.split("."),r=r[0]+"."+r[1],o=!1
for(let e=0,t=n.length;e<t;++e)if(0===n[e].propertyPath.indexOf(r,0)&&n[e].validationResults&&n[e].validationResults.length>0){o=!0
...
for(let e=0,r=t.length;e<r;++e)for(let r=0,n=o.length;r<n;++r)if(parseInt(t[e],10)===parseInt(o[r].code,10)&&E().isNonEmptyString(o[r].message))return o[r].message
return null}function T(t,o,r){if(f("array"===e.type(o),'Invalid configuration "propertyData"',1489932942),!E().isUndefinedOrNull(t)&&"array"===e.type(t)){const e=[]
for(let n=0,i=t.length;n<i;++n){let i=!1
for(let e=0,a=o.length;e<a;++e)parseInt(t[n],10)===parseInt(o[e].code,10)&&(i=!0,E().isNonEmptyString(r)?o[e].message=r:(o.splice(e,1),--a))
i||E().isNonEmptyString(r)&&e.push({code:t[n],message:r})}o=o.concat(e)}return o}function N(t){f("object"===e.type(t),'Invalid input "html"',1523904699),e(c().getDomElementClassName("inspectorEditor",!0)).each((function(){const t=e(this),o={}
...
const r=b(t,void 0)
if("array"===e.type(r.editors)){for(let t=0,o=r.editors.length;t<o;++t){const o=c().getTemplate(r.editors[t].templateName).clone()
if(!o.length)continue
const n=e(o.html())
e(n).first().addClass(c().getDomElementClassName("inspectorEditor")),getInspectorDomElement().append(e(n)),N(n),h(r.editors[t],n)}"function"===e.type(o)&&o()}}export function renderCollectionElementEditors(t,o){let r,n,a
...
m>0&&"header"===l.editors[0].identifier&&(n=document.createElement("div"),n.classList.add("panel-body"),r=document.createElement("div"),r.classList.add("panel-collapse","collapse"),r.id=v(t,o),r.appendChild(n))
for(let i=0;i<m;++i){const a=c().getTemplate(l.editors[i].templateName).clone()
if(!a.length)continue
const p=e(a.html())
e(p).first().addClass(D(t,l.editors[i].identifier)).addClass(c().getDomElementClassName("inspectorEditor")),0===i&&r?getCollectionElementDomElement(t,o).append(p).append(r):i===m-1&&r&&"removeButton"===l.editors[i].identifier||i>0&&r?n.append(p.get(0)):getCollectionElementDomElement(t,o).append(p),N(p),h(l.editors[i],p,o,t)}(2===m&&"header"===l.editors[0].identifier&&"removeButton"===l.editors[1].identifier||1===m&&"header"===l.editors[0].identifier)&&e(c().getDomElementDataIdentifierSelector("collapse"),d).remove(),p.isSortable&&function(t,o){t.addClass(c().getDomElementClassName("sortable")),new i(t.get(0),{draggable:c().getDomElementClassName("collectionElement",!0),filter:"input,textarea,select",preventOnFilter:!1,animation:200,fallbackTolerance:200,swapThreshold:.6,dragClass:"formeditor-sortable-drag",ghostClass:"formeditor-sortable-ghost",onEnd:function(t){let r
...
if(d)for(let e=0,o=n.length;e<o;++e)y().publish("view/inspector/collectionElement/existing/selected",[n[e].identifier,t])
l=!0
for(let e=0,t=o.selectOptions.length;e<t;++e){let t=!0
if(!E().isUndefinedOrNull(n))for(let r=0,i=n.length;r<i;++r)if(n[r].identifier===o.selectOptions[e].value){t=!1
break}t&&(p.append(new Option(o.selectOptions[e].label,o.selectOptions[e].value)),""!==o.selectOptions[e].value&&(l=!1))}if(l){c().getTemplatePropertyDomElement("select-group",r).off().empty().remove()
const e=c().getTemplatePropertyDomElement("label-no-select",r)
d?e.text(o.label):e.remove()}else c().getTemplatePropertyDomElement("label-no-select",r).remove(),p.on("change",(function(){if(""!==e(this).val()){const o=e(this).val()
...
if(!(2===o.length&&"header"===o[0].identifier&&"removeButton"===o[1].identifier||1===o.length&&"header"===o[0].identifier)){const e=document.createElement("button")
e.classList.add("panel-button","collapsed"),e.setAttribute("type","button"),e.setAttribute("data-bs-toggle","collapse"),e.setAttribute("data-bs-target",v(i,n,!0)),e.setAttribute("aria-expaned","false"),e.setAttribute("aria-controls",v(i,n))
const t=document.createElement("span")
t.classList.add("caret"),c().getTemplatePropertyDomElement("panel-heading-row",r).find(".panel-title").before(t),c().getTemplatePropertyDomElement("panel-heading-row",r).wrapInner(e)}const a=getCollectionElementDomElement(i,n).get(0).querySelector(".formeditor-inspector-element-remove-button")
if(a){const e=a.querySelector("button")
e.classList.add("btn-sm"),e.querySelector(".btn-label").classList.add("visually-hidden")
const t=document.createElement("div")
t.classList.add("panel-actions"),t.append(e),c().getTemplatePropertyDomElement("panel-heading-row",r).append(t)}a?.remove()},l=s().getFormEditorDefinition(i,n)
"iconIdentifier"in l?o.getIcon(l.iconIdentifier,o.sizes.small,null,o.states.default).then((function(e){a(e)})):a(),t.label&&c().getTemplatePropertyDomElement("panel-title",r).removeAttr("data-template-property").append(t.label)}export function renderFileMaxSizeEditor(t,o){if(f("object"===e.type(t),'Invalid parameter "editorConfiguration"',1475421258),f(E().isNonEmptyString(t.label),'Invalid configuration "label"',1475421257),f("object"===e.type(o),'Invalid parameter "editorHtml"',1475421259),t.label){const e=c().getTemplatePropertyDomElement("label",o),r=e.attr(c().getDomElementDataAttribute("maximumFileSize"))
e.append(t.label.replace("{0}",r))}}export function renderTextEditor(t,o,r,n){f("object"===e.type(t),'Invalid parameter "editorConfiguration"',1475421053),f("object"===e.type(o),'Invalid parameter "editorHtml"',1475421054),f(E().isNonEmptyString(t.label),'Invalid configuration "label"',1475421055),f(E().isNonEmptyString(t.propertyPath),'Invalid configuration "propertyPath"',1475421056),c().getTemplatePropertyDomElement("label",o).append(t.label),E().isNonEmptyString(t.fieldExplanationText)?c().getTemplatePropertyDomElement("fieldExplanationText",o).text(t.fieldExplanationText):c().getTemplatePropertyDomElement("fieldExplanationText",o).remove(),E().isNonEmptyString(t.placeholder)&&c().getTemplatePropertyDomElement("propertyPath",o).attr("placeholder",t.placeholder)
const i=s().buildPropertyPath(t.propertyPath,r,n),a=g().get(i)
if(C(i,o),c().getTemplatePropertyDomElement("propertyPath",o).val(a),!E().isUndefinedOrNull(t.additionalElementPropertyPaths)&&"array"===e.type(t.additionalElementPropertyPaths))for(let e=0,o=t.additionalElementPropertyPaths.length;e<o;++e)g().set(t.additionalElementPropertyPaths[e],a)
renderFormElementSelectorEditorAddition(t,o,i),c().getTemplatePropertyDomElement("propertyPath",o).on("keyup paste",(function(){if(t.doNotSetIfPropertyValueIsEmpty&&!E().isNonEmptyString(e(this).val())?g().unset(i):g().set(i,e(this).val()),C(i,o),!E().isUndefinedOrNull(t.additionalElementPropertyPaths)&&"array"===e.type(t.additionalElementPropertyPaths))for(let o=0,r=t.additionalElementPropertyPaths.length;o<r;++o)t.doNotSetIfPropertyValueIsEmpty&&!E().isNonEmptyString(e(this).val())?g().unset(t.additionalElementPropertyPaths[o]):g().set(t.additionalElementPropertyPaths[o],e(this).val())}))}export function renderValidationErrorMessageEditor(t,o){f("object"===e.type(t),'Invalid parameter "editorConfiguration"',1489874121),f("object"===e.type(o),'Invalid parameter "editorHtml"',1489874122),f(E().isNonEmptyString(t.label),'Invalid configuration "label"',1489874123),f(E().isNonEmptyString(t.propertyPath),'Invalid configuration "propertyPath"',1489874124),c().getTemplatePropertyDomElement("label",o).append(t.label),E().isNonEmptyString(t.fieldExplanationText)?c().getTemplatePropertyDomElement("fieldExplanationText",o).text(t.fieldExplanationText):c().getTemplatePropertyDomElement("fieldExplanationText",o).remove()
const r=s().buildPropertyPath(t.propertyPath)
let n=g().get(r)
if(!E().isUndefinedOrNull(n)&&"array"===e.type(n)){const e=x(t.errorCodes,n)
E().isUndefinedOrNull(e)||c().getTemplatePropertyDomElement("propertyPath",o).val(e)}c().getTemplatePropertyDomElement("propertyPath",o).on("keyup paste",(function(){n=g().get(r),E().isUndefinedOrNull(n)&&(n=[]),g().set(r,T(t.errorCodes,n,e(this).val()))}))}export function renderCountrySelectEditor(t,o,r,n){f("object"===e.type(t),'Invalid parameter "editorConfiguration"',1674826430),f("object"===e.type(o),'Invalid parameter "editorHtml"',1674826431),f(E().isNonEmptyString(t.label),'Invalid configuration "label"',1674826432)
...
a.empty()
for(let t=0,o=p.length;t<o;++t){let o=!1
for(const e of Object.keys(l))if(p[t].value===l[e]){o=!0
break}const r=new Option(p[t].text,t.toString(),!1,o)
e(r).data({value:p[t].value}),a.append(r)}a.on("change",(function(){const t=[]
...
for(let o=0,r=t.selectOptions.length;o<r;++o){let r
r=t.selectOptions[o].value===l?new Option(t.selectOptions[o].label,o.toString(),!1,!0):new Option(t.selectOptions[o].label,o.toString()),e(r).data({value:t.selectOptions[o].value}),a.append(r)}a.on("change",(function(){g().set(i,e("option:selected",e(this)).data("value"))}))}export function renderMultiSelectEditor(t,o,r,n){f("object"===e.type(t),'Invalid parameter "editorConfiguration"',1485712399),f("object"===e.type(o),'Invalid parameter "editorHtml"',1485712400),f(E().isNonEmptyString(t.label),'Invalid configuration "label"',1485712401),f(E().isNonEmptyString(t.propertyPath),'Invalid configuration "propertyPath"',1485712402),f("array"===e.type(t.selectOptions),'Invalid configuration "selectOptions"',1485712403)
const i=s().buildPropertyPath(t.propertyPath,r,n)
c().getTemplatePropertyDomElement("label",o).append(t.label)
const a=c().getTemplatePropertyDomElement("selectOptions",o),l=g().get(i)||{}
for(let o=0,r=t.selectOptions.length;o<r;++o){let r=null
for(const e of Object.keys(l))if(t.selectOptions[o].value===l[e]){r=new Option(t.selectOptions[o].label,o.toString(),!1,!0)
break}r||(r=new Option(t.selectOptions[o].label,o.toString())),e(r).data({value:t.selectOptions[o].value}),a.append(r)}a.on("change",(function(){const t=[]
...
if(m.text(d),m.data("viewPortIdentifier",d),m.data("viewPortLabel",s),m.attr("title",s),i.append(m),l===p-1){const t=e(n).clone(!0,!0)
P(o).after(t),a(m),m.addClass(c().getDomElementClassName("active"))}e("button",i).on("click",(function(){const t=e(this)
...
if("object"===e.type(h))for(const e of Object.keys(h))D(h[e],e)
else if("array"===e.type(h))for(const e in h)h.hasOwnProperty(e)&&(E().isUndefinedOrNull(h[e]._label)?D(h[e],e):D(h[e]._label,h[e]._value))
...
const t=e(c().getDomElementDataIdentifierSelector("formElementSelectorSplitButtonListContainer"),r)
t.off().empty()
const l=s().getNonCompositeNonToplevelFormElements()
0===l.length?o.getIcon(c().getDomElementDataAttributeValue("iconNotAvailable"),o.sizes.small,null,o.states.default).then((function(o){const r=e('<li data-no-sorting><span class="dropdown-item"></span></li>')
r.find("span").append(e(o)).append(" "+b(u(),"inspectorEditorFormElementSelectorNoElements")),t.append(r)})):e.each(l,(function(i,l){o.getIcon(b(l,"iconIdentifier"),o.sizes.small,null,o.states.default).then((function(o){const i=e('<li data-no-sorting><a href="#" class="dropdown-item" data-formelement-identifier="'+l.get("identifier")+'"></a></li>')
e(a`[data-formelement-identifier="${l.get("identifier")}"]`,i).append(e(o)).append(" "+l.get("label")),e("a",i).on("click",(function(){let t
t=g().get(n)||"",t=0===t.length?"{"+e(this).attr("data-formelement-identifier")+"}":t+" {"+e(this).attr("data-formelement-identifier")+"}",g().set(n,t),c().getTemplatePropertyDomElement("propertyPath",r).val(t),C(n,r)})),t.append(i)}))}))}else e(c().getDomElementDataIdentifierSelector("editorControlsInputGroup"),r).removeClass(c().getDomElementClassName("inspectorInputGroup")),i.off().empty().remove()}export function buildTitleByFormElement(t){let o
