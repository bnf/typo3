...
for(const[t,n]of Object.entries(i))t.match(/^__/)||(null===n||"object"!=typeof n||Array.isArray(n)?"function"!==e.type(n)&&"undefined"!==e.type(n)&&(r[t]=n):r[t]=this.convertToSimpleObject(n))
if("array"===e.type(n)){r.renderables=[]
for(let e=0,t=n.length;e<t;++e)r.renderables.push(this.convertToSimpleObject(n[e]))}return r}}export class PropertyValidationService{constructor(){this.validators={}}addValidatorIdentifiersToFormElementProperty(t,i,n,o,a,s){assert("object"===e.type(t),'Invalid parameter "formElement"',1475661025),assert("array"===e.type(i),'Invalid parameter "validators"',1475661026),assert("array"===e.type(i),'Invalid parameter "validators"',1479238074)
...
for(const e of i)-1===d[l][n].validators.indexOf(e)&&d[l][n].validators.push(e)
...
if(n in a)for(const e of Object.keys(a[n]||{}))e.indexOf(i)>-1||(o[e]=a[n][e])
...
for(const e of Object.keys(i||{}))e===t.get("__identifierPath")||e.indexOf(t.get("__identifierPath")+"/")>-1||(r[e]=i[e])
...
for(let n=0,l=s[o][i].validators.length;n<l;++n){const l=s[o][i].validators[n]
if("function"!==e.type(this.validators[l]))continue
const d=this.validators[l](t,i)
r.isNonEmptyString(d)&&a.push(d)}}return a.length>0&&"OR"===n.propertyValidatorsMode&&a.length!==s[o][i].validators.length?[]:a}validateFormElement(t){assert("object"===e.type(t),'Invalid parameter "formElement"',1475749668)
...
if(!r.isUndefinedOrNull(o[i]))for(const e of Object.keys(o[i]))n.push({propertyPath:e,validationResults:this.validateFormElementProperty(t,e)})
return n}validationResultsHasErrors(t){assert("array"===e.type(t),'Invalid parameter "validationResults"',1478613477)
for(let e=0,r=t.length;e<r;++e)for(let r=0,i=t[e].validationResults.length;r<i;++r)if(t[e].validationResults[r].validationResults&&t[e].validationResults[r].validationResults.length>0)return!0
...
if("array"===e.type(n))for(let e=0,t=n.length;e<t;++e)if(this.validateFormElementRecursive(n[e],r,i),r&&this.validationResultsHasErrors(i))return i
...
if(!r.isUndefinedOrNull(i.propertyCollections))for(const n of Object.keys(i.propertyCollections))if(Array.isArray(i.propertyCollections[n]))for(let o=0,a=i.propertyCollections[n].length;o<a;++o)if("array"===e.type(i.propertyCollections[n][o].editors)&&-1!==l.getIndexFromPropertyCollectionElementByIdentifier(i.propertyCollections[n][o].identifier,n,t))for(let a=0,s=i.propertyCollections[n][o].editors.length;a<s;++a){if("array"!==e.type(i.propertyCollections[n][o].editors[a].propertyValidators))continue
const s={propertyValidatorsMode:"AND"}
r.isUndefinedOrNull(i.propertyCollections[n][o].editors[a].propertyValidatorsMode)||"OR"!==i.propertyCollections[n][o].editors[a].propertyValidatorsMode||(s.propertyValidatorsMode="OR"),this.addValidatorIdentifiersToFormElementProperty(t,i.propertyCollections[n][o].editors[a].propertyValidators,i.propertyCollections[n][o].editors[a].propertyPath,i.propertyCollections[n][o].identifier,n,s)}}}export class PublisherSubscriber{constructor(){this.topics={},this.subscriberUid=-1}publish(e,t){if(assert(r.isNonEmptyString(e),'Invalid parameter "topic"',1475358066),r.isUndefinedOrNull(this.topics[e]))return
const i=this.topics[e]
for(const r of i)r.func(e,t)}subscribe(t,i){assert(r.isNonEmptyString(t),'Invalid parameter "topic"',1475358067),assert("function"===e.type(i),'Invalid parameter "func"',1475411986),r.isUndefinedOrNull(this.topics[t])&&(this.topics[t]=[])
...
for(const t of Object.values(this.topics)){const r=t
for(let t=0,i=r.length;t<i;++t)if(r[t].token===e)return r.splice(t,1),e}return null}}function t(r,i,n,o){if(assert("object"===e.type(r),'Invalid parameter "modelToExtend"',1475358069),assert("object"===e.type(i)||"array"===e.type(i),'Invalid parameter "modelExtension"',1475358070),o=!!o,n=n||"",e.isEmptyObject(i))assert(""!==n,"Empty path is not allowed",1474640022),r.on(n,"core/formElement/somePropertyChanged"),r.set(n,i,o)
else{const e={...i}
for(const a of Object.keys(e)){const s=""===n?a:n+"."+a
r.on(s,"core/formElement/somePropertyChanged"),null===e[a]||"object"!=typeof e[a]&&!Array.isArray(e[a])?"properties.options"===n?r.set(n,i,o):r.set(s,e[a],o):t(r,e[a],s,o)}}}export class Model{constructor(){this.objectData={},this.publisherTopics={}}get(e){let t,i
...
const m=this.get(t)
for(p=this.objectData,o=t;o.indexOf(".")>0;)a=o.slice(0,o.indexOf(".")),o=o.slice(a.length+1),e.isNumeric(a)&&(a=parseInt(a,10)),d=o.indexOf("."),l=-1===d?o:o.slice(0,d),"undefined"===e.type(p[a])?e.isNumeric(l)?p[a]=[]:p[a]={}:!1===e.isNumeric(l)&&"array"===e.type(p[a])&&(p[a]={...p[a]}),p=p[a]
if(p[o]=i,!r.isUndefinedOrNull(this.publisherTopics[t])&&!n)for(let e=0,r=this.publisherTopics[t].length;e<r;++e)s.publish(this.publisherTopics[t][e],[t,i,m,this.objectData.__identifierPath])}unset(e,t){let i,n,o
assert(r.isNonEmptyString(e),'Invalid parameter "key"',1489321637),t=!!t
const a=this.get(e)
if(e.indexOf(".")>0?(n=e.split("."),o=n.pop(),n=n.join("."),i=this.get(n),void 0!==i&&delete i[o]):assert(!1,"remove toplevel properties is not supported",1489319753),!r.isUndefinedOrNull(this.publisherTopics[e])&&!t)for(let t=0,r=this.publisherTopics[e].length;t<r;++t)s.publish(this.publisherTopics[e][t],[e,void 0,a,this.objectData.__identifierPath])}on(t,i){assert(r.isNonEmptyString(t),'Invalid parameter "key"',1475361757),assert(r.isNonEmptyString(i),'Invalid parameter "topicName"',1475361758),"array"!==e.type(this.publisherTopics[t])&&(this.publisherTopics[t]=[]),-1===this.publisherTopics[t].indexOf(i)&&this.publisherTopics[t].push(i)}off(t,i){assert(r.isNonEmptyString(t),'Invalid parameter "key"',1475361759),assert(r.isNonEmptyString(i),'Invalid parameter "topicName"',1475361760),"array"===e.type(this.publisherTopics[t])&&(this.publisherTopics[t]=this.publisherTopics[t].filter((e=>i!==e)))}getObjectData(){return e.extend(!0,{},this.objectData)}toString(){const e=this.getObjectData(),{renderables:t,__parentRenderable:i,...n}=e,o=t||null
let a=null
r.isUndefinedOrNull(i)||(a=i.getObjectData().__identifierPath+" (filtered)")
const s=n
if(null!==a&&(s.__parentRenderable=a),null!==o&&Array.isArray(o)){const e=[]
for(let t=0,r=o.length;t<r;++t){const r=o[t]
e.push(JSON.parse(r.toString()))}s.renderables=e}return JSON.stringify(s,null,2)}clone(){const e=this.getObjectData(),r=e.renderables||null
delete e.renderables,delete e.__parentRenderable,e.renderables=!!r||null
const i=new Model
if(t(i,e,"",!0),null!==r&&Array.isArray(r)){const e=[]
for(let t=0,n=r.length;t<n;++t){let n=r[t]
n=n.clone(),n.set("__parentRenderable",i,!0),e.push(n)}i.set("renderables",e,!0)}return i}}export class Repository{setFormEditorDefinitions(t){assert("object"===e.type(t),'Invalid parameter "formEditorDefinitions"',1475364394)
for(const e of Object.keys(t)){const r=e
if(null===t[r]||"object"==typeof t[r])for(const e of Object.keys(t[r]))null!==t[r][e]&&"object"==typeof t[r][e]||(t[r][e]={})}this.formEditorDefinitions=t}getFormEditorDefinition(t,i){return assert(r.isNonEmptyString(t),'Invalid parameter "definitionName"',1475364952),assert(r.isNonEmptyString(i),'Invalid parameter "subject"',1475364953),e.extend(!0,{},this.formEditorDefinitions[t][i])}getRootFormElement(){return getApplicationStateStack().getCurrentState("formDefinition")}addFormElement(t,i,n,a){let s,l,d
...
if(!p._isTopLevelFormElement&&m._isCompositeFormElement?("array"!==e.type(i.get("renderables"))&&i.set("renderables",[],a),t.set("__parentRenderable",i,a),t.set("__identifierPath",i.get("__identifierPath")+"/"+t.get("identifier"),a),i.get("renderables").push(t)):(i.get("__identifierPath")===getApplicationStateStack().getCurrentState("formDefinition").get("__identifierPath")?(d=i.get("renderables"),i=d[d.length-1]):p._isTopLevelFormElement&&!m._isTopLevelFormElement?i=this.findEnclosingCompositeFormElementWhichIsOnTopLevel(i):p._isCompositeFormElement&&(s=this.findEnclosingCompositeFormElementWhichIsNotOnTopLevel(i),s&&(i=s)),t.set("__parentRenderable",i.get("__parentRenderable"),a),t.set("__identifierPath",i.get("__parentRenderable").get("__identifierPath")+"/"+t.get("identifier"),a),l=i.get("__parentRenderable").get("renderables"),l.splice(l.indexOf(i)+1,0,t)),n&&"array"===e.type(p.editors))for(let i=0,n=p.editors.length;i<n;++i){if("array"!==e.type(p.editors[i].propertyValidators))continue
const n={propertyValidatorsMode:"AND"}
r.isUndefinedOrNull(p.editors[i].propertyValidatorsMode)||"OR"!==p.editors[i].propertyValidatorsMode||(n.propertyValidatorsMode="OR"),o.addValidatorIdentifiersToFormElementProperty(t,p.editors[i].propertyValidators,p.editors[i].propertyPath,void 0,void 0,n)}return t}removeFormElement(t,i,n){r.isUndefinedOrNull(n)&&(n=!0),n=!!n,i=!!i,assert("object"===e.type(t),'Invalid parameter "formElement"',1475364957),assert("object"===e.type(t.get("__parentRenderable")),"Removing the root element is not allowed",1472553024)
...
if("array"===e.type(l))for(let e=0,r=l.length;e<r;++e)m(l[e],t.get("__identifierPath"))}
return"inside"===i?(assert(!d._isTopLevelFormElement,"This move is not allowed",1476993731),assert(p._isCompositeFormElement,"This move is not allowed",1476993732),t.set("__parentRenderable",n,o),m(t,n.get("__identifierPath")),s=n.get("renderables"),r.isUndefinedOrNull(s)&&(s=[]),s.splice(0,0,t),n.set("renderables",s,o)):d._isTopLevelFormElement&&p._isTopLevelFormElement?(a=n.get("__parentRenderable").get("renderables"),l=a.indexOf(n),"after"===i?a.splice(l+1,0,t):a.splice(l,0,t),n.get("__parentRenderable").set("renderables",a,o)):(t.get("__parentRenderable").get("identifier")===n.get("__parentRenderable").get("identifier")?(a=n.get("__parentRenderable").get("renderables"),l=a.indexOf(n)):(t.set("__parentRenderable",n.get("__parentRenderable"),o),m(t,n.get("__parentRenderable").get("__identifierPath")),a=n.get("__parentRenderable").get("renderables"),l=a.indexOf(n)),"after"===i?a.splice(l+1,0,t):a.splice(l,0,t),n.get("__parentRenderable").set("renderables",a,o)),t}getIndexForEnclosingCompositeFormElementWhichIsOnTopLevelForFormElement(t){let r
...
return r=i._isTopLevelFormElement&&i._isCompositeFormElement?t:t.get("__identifierPath")===getApplicationStateStack().getCurrentState("formDefinition").get("__identifierPath")?getApplicationStateStack().getCurrentState("formDefinition").get("renderables")[0]:this.findEnclosingCompositeFormElementWhichIsOnTopLevel(t),r.get("__parentRenderable").get("renderables").indexOf(r)}findEnclosingCompositeFormElementWhichIsOnTopLevel(t){let r
...
if("array"===e.type(o))for(let e=0,t=o.length;e<t;++e)r(o[e])}
...
const n=r=>{let o
if(r.get("identifier")===t&&(i=!0),!i&&(o=r.get("renderables"),"array"===e.type(o)))for(let e=0,t=o.length;e<t&&(n(o[e]),!i);++e);}
...
for(const t of Object.keys(i))r.isUndefinedOrNull(l.formEditorDefinitions[t])||(y[t]=y[t]||{},f[t]=e.extend(y[t]||{},i[t]),delete y[t],delete i[t])
const g=""===(n=n||"")?i.identifier:n+"/"+i.identifier,h=function(e){e=e||{}
const r=new Model
return t(r,e,"",!0),r}({...y,...i,renderables:!!c||null,__parentRenderable:null,__identifierPath:g})
h.set("__parentRenderable",a||null,d)
for(const[e,t]of Object.entries(f)){let r=0
for(const i of Object.values(t)){let t
const n=this.createPropertyCollectionElement(i.identifier,i,e)
r>0&&(t=f[e][r-1].identifier),l.addPropertyCollectionElement(n,e,h,t,!0),++r}}if(s&&"array"===e.type(m.editors))for(let t=0,i=m.editors.length;t<i;++t){if("array"!==e.type(m.editors[t].propertyValidators))continue
const i={propertyValidatorsMode:"AND"}
r.isUndefinedOrNull(m.editors[t].propertyValidatorsMode)||"OR"!==m.editors[t].propertyValidatorsMode||(i.propertyValidatorsMode="OR"),o.addValidatorIdentifiersToFormElementProperty(h,m.editors[t].propertyValidators,m.editors[t].propertyPath,void 0,void 0,i)}if("array"===e.type(c)){p=[]
for(let e=0,t=c.length;e<t;++e)p.push(this.createFormElement(c[e],g,h,s,d))
