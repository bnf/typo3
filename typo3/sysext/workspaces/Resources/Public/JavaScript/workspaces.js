...
export default class Workspaces{constructor(){this.tid=0}renderSendToStageWindow(e){const a=e[0].result,r=o.advanced({title:TYPO3.lang.actionSendToStage,content:n`<div class="modal-loading"><typo3-backend-spinner size="large"></typo3-backend-spinner></div>`,severity:t.info,buttons:[{text:TYPO3.lang.cancel,active:!0,btnClass:"btn-default",name:"cancel",trigger:()=>{r.hideModal()}},{text:TYPO3.lang.ok,btnClass:"btn-primary",name:"ok"}],callback:e=>{const t=e.ownerDocument.createElement("typo3-workspaces-send-to-stage-form")
t.data=a,t.TYPO3lang=TYPO3.lang,e.querySelector(".t3js-modal-body").replaceChildren(t)}})
return r}sendRemoteRequest(t,progressContainer="#workspace-content-wrapper"){return a.configure({parent:progressContainer,showSpinner:!1}),a.start(),new e(TYPO3.settings.ajaxUrls.workspace_dispatch).post(t,{headers:{"Content-Type":"application/json; charset=utf-8"}}).finally((()=>a.done()))}generateRemotePayload(e,data={}){return this.generateRemotePayloadBody("RemoteServer",e,data)}generateRemoteMassActionsPayload(e,data={}){return this.generateRemotePayloadBody("MassActions",e,data)}generateRemoteActionsPayload(e,data={}){return this.generateRemotePayloadBody("Actions",e,data)}generateRemotePayloadBody(e,t,a){return a instanceof Array?a.push(TYPO3.settings.Workspaces.token):a=[a,TYPO3.settings.Workspaces.token],{action:e,data:a,method:t,type:"rpc",tid:this.tid++}}}