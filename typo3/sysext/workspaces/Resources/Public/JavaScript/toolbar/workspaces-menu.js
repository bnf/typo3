...
import{ModuleStateStorage as a}from"@typo3/backend/storage/module-state-storage.js"
var s,c
!function(e){e.scaffoldSelector=".t3js-scaffold",e.containerSelector="#typo3-cms-workspaces-backend-toolbaritems-workspaceselectortoolbaritem",e.activeMenuItemLinkSelector=".t3js-workspaces-switchlink.active",e.menuItemLinkSelector=".t3js-workspaces-switchlink",e.toolbarItemSelector=".dropdown-toggle"}(s||(s={})),function(e){e.workspaceBodyClass="scaffold-in-workspace",e.workspacesTitleInToolbarClass="toolbar-item-name"}(c||(c={}))
class n{constructor(){o.Topbar.Toolbar.registerEvent((()=>{this.initializeEvents(),n.updateBackendContext()})),new r("typo3:datahandler:process",(e=>{const t=e.detail.payload
"sys_workspace"===t.table&&"delete"===t.action&&!1===t.hasErrors&&o.Topbar.refresh()})).bindTo(document)}static refreshPageTree(){document.dispatchEvent(new CustomEvent("typo3:pagetree:refresh"))}static getWorkspaceState(){const e=document.querySelector([s.containerSelector,s.activeMenuItemLinkSelector].join(" "))
