 ...
 */
var e=function(e,t,r,n){var l,i=arguments.length,s=i<3?t:null===n?n=Object.getOwnPropertyDescriptor(t,r):n
if("object"==typeof Reflect&&"function"==typeof Reflect.decorate)s=Reflect.decorate(e,t,r,n)
else for(var o=e.length-1;o>=0;o--)(l=e[o])&&(s=(i<3?l(s):i>3?l(t,r,s):l(t,r))||s)
...
for(const[r,l]of Object.entries(e)){const e=l.length
t.push(n`<h6 class="livesearch-result-item-group-label">${r} (${e})</h6>`),t.push(...l.map((e=>n`${o(this.renderResultItem(e),n`<typo3-backend-spinner></typo3-backend-spinner>`)}`)))}return n`${t}`}async renderResultItem(e){const r=t.getRenderers()
let l
...
e([s({type:Object,attribute:!1})],a.prototype,"results",void 0),a=e([i("typo3-backend-live-search-result-item-container")],a)
...
let r
if(e.preventDefault(),"ArrowDown"===e.key){let e=document.activeElement.nextElementSibling
for(;null!==e&&e.tagName.toLowerCase()!==t;)e=e.nextElementSibling
r=e}else if("ArrowUp"===e.key){let e=document.activeElement.previousElementSibling
for(;null!==e&&e.tagName.toLowerCase()!==t;)e=e.previousElementSibling
r=e,null===r&&(r=document.querySelector("typo3-backend-live-search").querySelector('input[type="search"]'))}else"ArrowRight"===e.key&&(r=this.resultItemDetailContainer.querySelector("typo3-backend-live-search-result-item-action"))
...
c=e([i("typo3-backend-live-search-result-list")],c)
