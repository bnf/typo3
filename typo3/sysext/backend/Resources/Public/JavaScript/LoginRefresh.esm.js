...
class LoginRefresh {
    ...
    initializeLoginForm() {
        ...
        }).append(jQuery('<div />').append(jQuery('<input />', { type: 'text', name: 'username', class: 'd-none', value: TYPO3.configuration.username }), jQuery('<input />', { type: 'hidden', name: 'userident', id: 't3-loginrefresh-userident' })), jQuery('<div />', { class: 'form-group' }).append(jQuery('<input />', {
            type: 'password',
            name: 'p_field',
            autofocus: 'autofocus',
            class: 'form-control',
