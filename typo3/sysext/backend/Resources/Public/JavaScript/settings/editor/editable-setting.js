...
var __decorate=function(t,e,i,o){var n,s=arguments.length,r=s<3?e:null===o?o=Object.getOwnPropertyDescriptor(e,i):o;if("object"==typeof Reflect&&"function"==typeof Reflect.decorate)r=Reflect.decorate(t,e,i,o);else for(var a=t.length-1;a>=0;a--)(n=t[a])&&(r=(s<3?n(r):s>3?n(e,i,r):n(e,i))||r);return s>3&&r&&Object.defineProperty(e,i,r),r};import{html,LitElement}from"lit";import{customElement,property}from"lit/decorators.js";import{until}from"lit/directives/until.js";import"@typo3/backend/element/spinner-element.js";import"@typo3/backend/element/icon-element.js";import{copyToClipboard}from"@typo3/backend/copy-to-clipboard.js";import Notification from"@typo3/backend/notification.js";import{lll}from"@typo3/core/lit-helper.js";import AjaxRequest from"@typo3/core/ajax/ajax-request.js";let EditableSettingElement=class extends LitElement{constructor(){super(...arguments),this.typeElement=null}createRenderRoot(){return this}render(){const{value:t,valueFromSets:e,definition:i}=this.setting;return html`
    ...
    `}async renderField(){const{definition:t,value:e,typeImplementation:i}=this.setting;let o=this.typeElement;if(!o){const t=await import(i);if(!("componentName"in t))throw new Error(`module ${i} is missing the "componentName" export`);o=document.createElement(t.componentName),this.typeElement=o}return o.setAttribute("key",t.key),o.setAttribute("name",`settings[${t.key}]`),o.setAttribute("value",Array.isArray(e)?JSON.stringify(e):String(e)),o.setAttribute("default",Array.isArray(t.default)?JSON.stringify(t.default):String(t.default)),o}renderActions(){const{definition:t}=this.setting;return html`
      <div class="dropdown">
