...
var __decorate=function(e,t,i,r){var o,s=arguments.length,n=s<3?t:null===r?r=Object.getOwnPropertyDescriptor(t,i):r;if("object"==typeof Reflect&&"function"==typeof Reflect.decorate)n=Reflect.decorate(e,t,i,r);else for(var a=e.length-1;a>=0;a--)(o=e[a])&&(n=(s<3?o(n):s>3?o(t,i,n):o(t,i))||n);return s>3&&n&&Object.defineProperty(t,i,n),n};import{html,LitElement,nothing}from"lit";import{customElement,property,state}from"lit/decorators.js";import{live}from"lit/directives/live.js";import"@typo3/backend/element/spinner-element.js";import"@typo3/backend/element/icon-element.js";import Notification from"@typo3/backend/notification.js";import AjaxRequest from"@typo3/core/ajax/ajax-request.js";import{copyToClipboard}from"@typo3/backend/copy-to-clipboard.js";import{lll}from"@typo3/core/lit-helper.js";import"@typo3/backend/settings/editor/editable-setting.js";import"@typo3/backend/element/icon-element.js";import"@typo3/backend/settings/type/bool.js";import"@typo3/backend/settings/type/int.js";import"@typo3/backend/settings/type/number.js";import"@typo3/backend/settings/type/string.js";import"@typo3/backend/settings/type/stringlist.js";let SettingsEditorElement=class extends LitElement{constructor(){super(...arguments),this.customFormData={},this.readonly=!1,this.searchTerm="",this.activeCategory="",this.visibleCategories={},this.observer=null}createRenderRoot(){return this}firstUpdated(){let e="0px 0px 0px 0px";const t=document.querySelector(".module-docheader");t&&(e=`-${getComputedStyle(t).getPropertyValue("min-height")} 0px 0px 0px`),this.observer=new IntersectionObserver((e=>{e.forEach((e=>{const t=e.target.dataset.key;this.visibleCategories[t]=e.isIntersecting}));const t=e=>e.reduce(((e,i)=>[...e,i.key,...t(i.categories)]),[]),i=t(this.categories).filter((e=>this.visibleCategories[e]))[0]||"";i&&(this.activeCategory=i)}),{root:document.querySelector(".module"),threshold:.1,rootMargin:e})}updated(e){if([...this.renderRoot.querySelectorAll(".settings-category")].map((e=>this.observer?.observe(e))),e.has("activeCategory")){const e=this.querySelector(".settings-navigation-item.active");e&&"scrollIntoViewIfNeeded"in e&&"function"==typeof e.scrollIntoViewIfNeeded?e.scrollIntoViewIfNeeded():e?.scrollIntoView()}}renderCategoryTree(e,t){return html`
    ...
    `}renderSettings(e,t){return e.map((e=>html`
      ...
      `}
    `))}renderHeadline(e,t,i){switch(e){case 1:return html`<h1 id=${t}>${i}</h1>`;case 2:return html`<h2 id=${t}>${i}</h2>`;case 3:return html`<h3 id=${t}>${i}</h3>`;case 4:return html`<h4 id=${t}>${i}</h4>`;case 5:return html`<h5 id=${t}>${i}</h5>`;case 6:return html`<h6 id=${t}>${i}</h6>`;default:throw new Error(`Invalid header level: ${e}`)}}async onSubmit(e){const t=e.target;if("export"===e.submitter?.value){e.preventDefault();const i=new FormData(t),r=await new AjaxRequest(this.dumpUrl).post(i),o=await r.resolve();"string"==typeof o.yaml?copyToClipboard(o.yaml):(console.warn("Value can not be copied to clipboard.",typeof o.yaml),Notification.error(lll("copyToClipboard.error")))}this.provideEvents&&this.dispatchEvent(new CustomEvent("typo3:settings-editor:submit",{detail:{originalEvent:e,formData:Object.fromEntries(new FormData(t))}}))}async onSearch(e){e.preventDefault(),this.searchTerm=e.currentTarget.value}render(){const e=this.filterCategories(),t=e.filter((e=>!e.__hidden)).length>0;return html`
