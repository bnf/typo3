 ...
 */
var __decorate=function(e,t,o,r){var l,n=arguments.length,a=n<3?t:null===r?r=Object.getOwnPropertyDescriptor(t,o):r;if("object"==typeof Reflect&&"function"==typeof Reflect.decorate)a=Reflect.decorate(e,t,o,r);else for(var i=e.length-1;i>=0;i--)(l=e[i])&&(a=(n<3?l(a):n>3?l(t,o,a):l(t,o))||a);return n>3&&a&&Object.defineProperty(t,o,a),a};import{html,LitElement}from"lit";import{customElement,property}from"lit/decorators.js";import Alwan from"alwan";let ColorTypeElement=class extends LitElement{constructor(){super(...arguments),this.alwan=null}createRenderRoot(){return this}firstUpdated(){this.alwan=new Alwan(this.querySelector("input"),{position:"bottom-start",format:"hex",opacity:!1,preset:!1,color:this.value}),this.alwan.on("color",(e=>{this.value=e.hex}))}render(){return html`
      <input
        class="form-control"
        id=${this.key}
        type="string"
