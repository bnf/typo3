...
import { BackendException } from './BackendException.esm.js';
...
*/
  ...
  FormEngine.getFieldElement = function(fieldName, appendix, noFallback) {
    ...
    if (appendix) {
      ...
      switch (appendix) {
        case '_list':
          $fieldEl = jQuery(':input[data-formengine-input-name="' + fieldName + '"]:not([type=hidden])', $formEl);
          break;
        case '_avail':
