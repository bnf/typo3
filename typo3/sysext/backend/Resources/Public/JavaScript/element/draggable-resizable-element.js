...
if(1===t.buttons&&this.contains(i)){if(i.dataset.resize){const s="resize"+i.dataset.resize.toUpperCase()
this.action=e[s]}else this.action=e.move
...
if(this.action===e.move&&(n.left=this.minMax(n.left+i.x,0,s.width-n.width),n.top=this.minMax(n.top+i.y,0,s.height-n.height)),a.includes(this.action)){const r=this.minMax(i.y,-n.top,n.height-2)
n.top+=r,n.height-=r}else d.includes(this.action)&&(n.height=this.minMax(n.height+i.y,2,s.height-n.top))
if(l.includes(this.action)){const o=this.minMax(i.x,-n.left,n.width-2)
n.left+=o,n.width-=o}else h.includes(this.action)&&(n.width+=i.x)
