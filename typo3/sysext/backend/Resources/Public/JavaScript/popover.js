...
null!==o?o.toggle():console.warn("Failed to get popover instance for element.")}toIterable(e){let t
if(e instanceof HTMLElement)t=[e]
else{if(!(e instanceof NodeList))throw`Cannot consume element of type ${e.constructor.name}, expected NodeListOf<HTMLElement> or HTMLElement`
t=e}return t}applyTitleIfAvailable(e){const t=e.title||e.dataset.title||""
t&&(e.dataset.bsTitle=t)}}
