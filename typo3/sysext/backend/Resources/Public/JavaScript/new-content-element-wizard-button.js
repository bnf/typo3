 ...
 */
var t=function(t,e,r,o){var n,i=arguments.length,s=i<3?e:null===o?o=Object.getOwnPropertyDescriptor(e,r):o
...
import{html as o,css as n,LitElement as i}from"lit"
...
let c=class extends i{static{this.styles=[n`:host{-webkit-appearance:button;-moz-appearance:button;appearance:button;cursor:pointer}`]}constructor(){super(),this.addEventListener("click",(t=>{t.preventDefault(),this.renderWizard()})),this.addEventListener("keydown",(t=>{"Enter"!==t.key&&" "!==t.key||(t.preventDefault(),this.renderWizard())}))}connectedCallback(){this.hasAttribute("role")||this.setAttribute("role","button"),this.hasAttribute("tabindex")||this.setAttribute("tabindex","0")}render(){return o`<slot></slot>`}renderWizard(){this.url&&s.advanced({content:this.url,title:this.subject,severity:a.notice,size:s.sizes.large,type:s.types.ajax})}}
