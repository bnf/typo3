...
const{nodes:r}=e.detail,n=this.transformModuleStateIdentifierToNodeIdentifier(i.treeIdentifier),d=this.transformModuleStateIdentifierToNodeIdentifier(i.identifier),o=r.find((e=>null!==i.treeIdentifier&&e.__treeIdentifier===n||null===i.treeIdentifier&&e.identifier===d))
if(!o)return
null===i.treeIdentifier&&(i=t.updateWithTreeIdentifier(this.moduleStateType,this.transformNodeIdentifierToModuleStateIdentifier(o.identifier),this.transformNodeIdentifierToModuleStateIdentifier(o.__treeIdentifier))),o.checked=!0
const s=r.find((e=>e.__treeIdentifier===o.__parents.join("_")))
s&&!s.__expanded&&this.tree.updateComplete.then((()=>this.tree.expandNodeParents(o)))},this.fetchActiveNodeIfMissing=async()=>{const e=t.current(this.moduleStateType)
...
r?await this.selectActiveNodeByParents(t,r.__parents,false):await this.selectActiveViaRootline(t)}}connectedCallback(){super.connectedCallback(),document.addEventListener("typo3:module-state-storage:update:"+this.moduleStateType,this.moduleStateUpdated)}disconnectedCallback(){super.disconnectedCallback(),document.removeEventListener("typo3:module-state-storage:update:"+this.moduleStateType,this.moduleStateUpdated)}transformModuleStateIdentifierToNodeIdentifier(e){return e}transformNodeIdentifierToModuleStateIdentifier(e){return e}async selectActiveViaRootline(t){const i=new URL(this.tree.settings.rootlineUrl,window.location.origin)
i.searchParams.set("identifier",t)
const r=await new e(i.toString()).get({cache:"no-cache"}),{rootline:n}=await r.resolve()
n.pop()
await this.selectActiveNodeByParents(t,n.map((e=>this.transformModuleStateIdentifierToNodeIdentifier(e))),!1)}async selectActiveNodeByParents(e,t,i=!0){await this.tree.expandParents(t)
const r=this.transformModuleStateIdentifierToNodeIdentifier(e),n=this.tree.nodes.find((e=>e.identifier===r))
n&&this.tree.selectNode(n,i)}}
