 ...
 */
var e=function(e,t,o,r){var n,i=arguments.length,s=i<3?t:null===r?r=Object.getOwnPropertyDescriptor(t,o):r
if("object"==typeof Reflect&&"function"==typeof Reflect.decorate)s=Reflect.decorate(e,t,o,r)
else for(var a=e.length-1;a>=0;a--)(n=e[a])&&(s=(i<3?n(s):i>3?n(t,o,s):n(t,o))||s)
return i>3&&s&&Object.defineProperty(t,o,s),s}
import{html as t,LitElement as o}from"lit"
import{customElement as r,query as n}from"lit/decorators.js"
import"@typo3/backend/element/icon-element.js"
import{SeverityEnum as i}from"@typo3/backend/enum/severity.js"
import"@typo3/backend/tree/tree-toolbar.js"
import{TreeNodePositionEnum as s}from"@typo3/backend/tree/tree-node.js"
import{FileStorageTree as a}from"@typo3/backend/tree/file-storage-tree.js"
import{TreeModuleState as d}from"@typo3/backend/tree/tree-module-state.js"
import c from"@typo3/backend/context-menu.js"
...
import{ModuleUtility as f}from"@typo3/backend/module.js"
import{FileListDragDropEvent as u}from"@typo3/filelist/file-list-dragdrop.js"
import{Resource as m}from"@typo3/backend/resource/resource.js"
import{DataTransferTypes as h}from"@typo3/backend/enum/data-transfer-types.js"
export const navigationComponentName="typo3-backend-navigation-component-filestoragetree"
let g=class extends a{constructor(){super(...arguments),this.allowNodeDrag=!0}handleNodeMove(e,t,o){if(!this.isDropAllowed(t,e))return
const r=this.getDropCommandDetails(t,e,o)
if(null===r)return
...
let N=class extends(d(o)){constructor(){super(...arguments),this.moduleStateType="media",this.refresh=()=>{this.tree.refreshOrFilterTree()},this.selectFirstNode=()=>{const e=this.tree.nodes[0]
e&&this.tree.selectNode(e,!0)},this.loadContent=e=>{const t=e.detail.node
if(!t?.checked)return
if(p.updateWithTreeIdentifier("media",decodeURIComponent(t.identifier),decodeURIComponent(t.__treeIdentifier)),!1===e.detail.propagate)return
const o=top.TYPO3.ModuleMenu.App
let r=f.getFromName(o.getCurrentModule()).link
r+=r.includes("?")?"&":"?",top.TYPO3.Backend.ContentContainer.setUrl(r+"id="+t.identifier)},this.showContextMenu=e=>{const t=e.detail.node
