 ...
 */
var e=function(e,t,i,o){var s,n=arguments.length,r=n<3?t:null===o?o=Object.getOwnPropertyDescriptor(t,i):o
if("object"==typeof Reflect&&"function"==typeof Reflect.decorate)r=Reflect.decorate(e,t,i,o)
else for(var d=e.length-1;d>=0;d--)(s=e[d])&&(r=(n<3?s(r):n>3?s(t,i,r):s(t,i))||r)
return n>3&&r&&Object.defineProperty(t,i,r),r}
import{html as t,LitElement as i,nothing as o}from"lit"
import{property as s,state as n,query as r}from"lit/decorators.js"
...
this.selectNode(e,!0),this.focusNode(e)}selectNode(e,t=!0){this.isNodeSelectable(e)&&(this.resetSelectedNodes(),e.checked=!0,this.dispatchEvent(new CustomEvent("typo3:tree:node-selected",{detail:{node:e,propagate:t}})))}async focusNode(e){this.lastFocusedNode=this.focusedNode,this.focusedNode=e,this.requestUpdate()
...
const s=i===c.INSIDE?t:this.getParentNode(t),n=this.enhanceNodes([s,{...e,depth:s?s.depth+1:0}]).pop()
s&&(s.hasChildren&&!s.__expanded&&await this.showChildren(s),s.hasChildren||(s.hasChildren=!0,s.__expanded=!0)),i!==c.INSIDE&&i!==c.AFTER||o++,this.nodes.splice(o,0,n),this.handleNodeAdd(n,t,i)}async removeNode(e){const t=this.nodes.indexOf(e),i=this.getParentNode(e)
...
t?this.selectNode(t,!1):this.loadData()}else this.loadData()}errorNotification(e=null){if(!this.muteErrorNotifications)if(Array.isArray(e))e.forEach((e=>{p.error(e.title,e.message)}))
else{let t=this.networkErrorTitle
e&&e.target&&(e.target.status||e.target.statusText)&&(t+=" - "+(e.target.status||"")+" "+(e.target.statusText||"")),p.error(t,this.networkErrorMessage)}}getSelectedNodes(){return this.nodes.filter((e=>e.checked))}getNodeByTreeIdentifier(e){return this.nodes.find((t=>t.__treeIdentifier===e))}getNodeDragStatusIcon(){return this.nodeDragMode===h.DELETE?"actions-delete":this.nodeDragMode===h.NEW?"actions-add":this.nodeDragPosition===c.BEFORE?"apps-pagetree-drag-move-above":this.nodeDragPosition===c.INSIDE?"apps-pagetree-drag-move-into":this.nodeDragPosition===c.AFTER?"apps-pagetree-drag-move-below":"actions-ban"}async expandParents(e){for(const t of e){const e=this.nodes.find((e=>e.identifier===t.toString()))
if(!e)return
e.__expanded||await this.showChildren(e)}}async expandNodeParents(e){await this.expandParents(e.__parents)}prepareNodes(e){const t=new CustomEvent("typo3:tree:nodes-prepared",{detail:{nodes:e},bubbles:!1})
...
e.dataTransfer.setData(f.dragTooltip,JSON.stringify(i)),this.createDataTransferItemsFromNode(t).forEach((({data:t,type:i})=>e.dataTransfer.items.add(t,i))),e.dataTransfer.effectAllowed="move"}handleNodeDragOver(e){if(!e.dataTransfer.types.includes(f.treenode)&&!e.dataTransfer.types.includes(f.newTreenode))return!1
...
if(s.textContent=i,i=s.innerHTML,this.searchTerm){const e=new RegExp(this.searchTerm.replace(/[/\-\\^$*+?.()|[\]{}]/g,"\\$&"),"gi")
i=i.replace(e,'<span class="node-highlight-text">$&</span>')}return t`<div class="node-contentlabel"><div class="node-name" .innerHTML="${i}"></div>${e.note?t`<div class="node-note">${e.note}</div>`:o}</div>`}createNodeStatusInformation(e){const i=this.getNodeStatusInformation(e)
if(0===i.length)return t`${o}`
const s=i[0],n=m.getCssClass(s.severity),r=""!==s.icon?s.icon:"actions-dot",d=""!==s.overlayIcon?s.overlayIcon:void 0
return t`<span class="node-information"><typo3-backend-icon class="text-${n}" identifier="${r}" overlay="${l(d)}" size="small"></typo3-backend-icon></span>`}createNodeDeleteDropZone(e){return this.draggingNode===e&&e.deletable?t`<div class="node-dropzone-delete" data-tree-dropzone="delete"><typo3-backend-icon identifier="actions-delete" size="small"></typo3-backend-icon>${TYPO3.lang.deleteItem}</div>`:t`${o}`}createNodeForm(e){const i=e.identifier.startsWith("NEW")?h.NEW:h.EDIT
...
if(null===i)return
const o=this.getParentNode(i),s=this.getFirstNode(),n=this.getPreviousNode(i),r=this.getNextNode(i),d=this.getLastNode()
...
break
case u.UP:null!==n&&(this.scrollNodeIntoVisibleArea(n),this.focusNode(n))
break
case u.DOWN:null!==r&&(this.scrollNodeIntoVisibleArea(r),this.focusNode(r))
break
case u.LEFT:i.__expanded?i.hasChildren&&this.hideChildren(i):o&&(this.scrollNodeIntoVisibleArea(o),this.focusNode(o))
break
case u.RIGHT:i.__expanded&&r?(this.scrollNodeIntoVisibleArea(r),this.focusNode(r)):i.hasChildren&&this.showChildren(i)
break
...
if(!(o&&s)){let e=this.currentScrollPosition
o||s?o?s||(e=i-this.currentVisibleHeight):e=t:e=i-this.currentVisibleHeight,e<0&&(e=0),this.root.scrollTo({top:e})}}registerUnloadHandler(){try{if(!window.frameElement)return
window.addEventListener("pagehide",(()=>this.muteErrorNotifications=!0),{once:!0})}catch{console.error("Failed to check the existence of window.frameElement – using a foreign origin?")}}}e([s({type:Object})],Tree.prototype,"setup",void 0),e([n()],Tree.prototype,"settings",void 0),e([r(".nodes-root")],Tree.prototype,"root",void 0),e([n()],Tree.prototype,"nodes",void 0),e([n()],Tree.prototype,"currentScrollPosition",void 0),e([n()],Tree.prototype,"currentVisibleHeight",void 0),e([n()],Tree.prototype,"searchTerm",void 0),e([n()],Tree.prototype,"loading",void 0),e([n()],Tree.prototype,"hoveredNode",void 0),e([n()],Tree.prototype,"nodeDragAllowed",void 0)
