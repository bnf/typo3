...
if(r.file){const a={actionName:"typo3:foreignRelation:insert",objectGroup:s,table:"sys_file",uid:r.file}
t.send(a),n.hideModal()}else i.error(top.TYPO3.lang["online_media.error.new_media.failed"],r.error)
