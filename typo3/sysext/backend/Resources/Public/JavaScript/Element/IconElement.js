...
var __decorate=this&&this.__decorate||function(e,t,i,n){var o,r=arguments.length,s=r<3?t:null===n?n=Object.getOwnPropertyDescriptor(t,i):n;if("object"==typeof Reflect&&"function"==typeof Reflect.decorate)s=Reflect.decorate(e,t,i,n);else for(var a=e.length-1;a>=0;a--)(o=e[a])&&(s=(r<3?o(s):r>3?o(t,i,s):o(t,i))||s);return r>3&&s&&Object.defineProperty(t,i,s),s};define(["require","exports","lit-element","lit-html/directives/unsafe-html","lit-html/directives/until","../Icons","../Enum/IconTypes","TYPO3/CMS/Backend/Element/SpinnerElement"],(function(e,t,i,n,o,r,s){"use strict";Object.defineProperty(t,"__esModule",{value:!0}),t.IconElement=void 0;let a=class extends i.LitElement{constructor(){super(...arguments),this.size=s.Sizes.default,this.state=s.States.default,this.overlay=null,this.markup=s.MarkupIdentifiers.inline,this.raw=null}static get styles(){const e=(e,t)=>i.css`
    ...
    `;return[i.css`
      ...
      `,e(i.unsafeCSS(s.Sizes.small),16),e(i.unsafeCSS(s.Sizes.default),32),e(i.unsafeCSS(s.Sizes.large),48),e(i.unsafeCSS(s.Sizes.mega),64)]}render(){if(this.raw)return i.html`${n.unsafeHTML(this.raw)}`;if(!this.identifier)return i.html``;const e=r.getIcon(this.identifier,this.size,this.overlay,this.state,this.markup).then(e=>i.html`
          ${n.unsafeHTML(e)}
