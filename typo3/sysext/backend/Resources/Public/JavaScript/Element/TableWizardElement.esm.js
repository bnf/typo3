 ...
 */
let TableWizardElement = class TableWizardElement extends h {
    constructor() {
        super(...arguments);
        this.type = 'textarea';
        this.table = [];
