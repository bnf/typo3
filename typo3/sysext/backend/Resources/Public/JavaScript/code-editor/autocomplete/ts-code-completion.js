...
const r=[]
for(let e=0;e<this.proposals.length;e++)r[e]=this.proposals[e].word
...
if(e[t].v&&e[t].v.startsWith("<")&&!e[t].v.includes(">")){const o=e[t].v.replace(/</,"").trim();-1===o.indexOf(" ")&&(s=this.getExtChildNode(o),null!==s&&(e[t]=s))}!s&&e[t].c&&this.resolveExtReferencesRec(e[t].c)}}getExtChildNode(e){let t=this.extTsObjTree
const s=e.split(".")
for(let e=0;e<s.length;e++){const o=s[e]
if(void 0===t.c||void 0===t.c[o])return null
t=t.c[o]}return t}getFilter(e){return e.completingAfterDot?"":e.token.string.replace(".","").replace(/\s/g,"")}}