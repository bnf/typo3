...
class DragDrop {
    ...
    static onDrop($draggableElement, $droppableElement, evt) {
        ...
        if (typeof (contentElementUid) === 'number' && contentElementUid > 0) {
            ...
            const isCopyAction = (evt && evt.originalEvent.ctrlKey || $droppableElement.hasClass('t3js-paste-copy'));
            ...
            DragDrop.ajaxAction($droppableElement, $draggableElement, parameters, isCopyAction).then(() => {
     ...
     * @private
     */
    static ajaxAction($droppableElement, $draggableElement, parameters, isCopyAction) {
