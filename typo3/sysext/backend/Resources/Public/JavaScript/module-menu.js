...
import{Collapse as p}from"bootstrap"
import{KeyTypesEnum as g}from"@typo3/backend/enum/key-types.js"
var f
!function(e){e.menu="[data-modulemenu]",e.item="[data-modulemenu-identifier]",e.collapsible='[data-modulemenu-collapsible="true"]'}(f||(f={}))
class h{constructor(){this.loadedModule=null,c.ready().then((()=>{this.initialize()}))}static getModuleMenuItemFromElement(e){return{identifier:e.dataset.modulemenuIdentifier,level:e.parentElement.dataset.modulemenuLevel?parseInt(e.parentElement.dataset.modulemenuLevel,10):null,collapsible:"true"===e.dataset.modulemenuCollapsible,expanded:"true"===e.attributes.getNamedItem("aria-expanded")?.value,element:e}}static getCollapsedMainMenuItems(){return l.isset("modulemenu")?JSON.parse(l.get("modulemenu")):{}}static addCollapsedMainMenuItem(e){const t=h.getCollapsedMainMenuItems()
t[e]=!0,l.set("modulemenu",JSON.stringify(t))}static removeCollapseMainMenuItem(e){const t=this.getCollapsedMainMenuItems()
delete t[e],l.set("modulemenu",JSON.stringify(t))}static includeId(e,t){if(!e.navigationComponentId)return t
let n=""
...
break
case g.DOWN:o=h.getNextItem(n.element)
break
case g.LEFT:n.collapsible&&h.toggleModuleGroup(n.element,!1),n.level>1&&(o=h.getParentItem(n.element))
break
case g.RIGHT:n.collapsible&&(h.toggleModuleGroup(n.element,!0),o=h.getFirstChildItem(n.element))
break
case g.HOME:if(e.ctrlKey&&n.level>1){o=document.querySelector(f.menu+" "+f.item)
break}o=h.getFirstItem(n.element)
break
case g.END:o=e.ctrlKey&&n.level>1?h.getLastItem(document.querySelector(f.menu+" "+f.item)):h.getLastItem(n.element)
break
case g.SPACE:case g.ENTER:if(e.preventDefault(),e.repeat)break
n.collapsible?(h.toggleModuleGroup(n.element,!0),o=h.getFirstChildItem(n.element)):n.element.click()
break
