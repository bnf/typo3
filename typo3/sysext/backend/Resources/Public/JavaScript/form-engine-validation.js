...
if(void 0!==t.dataset.config){const e=JSON.parse(t.dataset.config),i=FormEngineValidation.formatByEvals(e,t.value)
i.length&&(a.value=i)}new RegularEvent("change",(()=>{FormEngineValidation.updateInputField(a.dataset.formengineInputName)})).bindTo(a),a.dataset.formengineInputInitialized="true"}static registerCustomEvaluation(e,t){customEvaluations.has(e)||customEvaluations.set(e,t)}static formatByEvals(e,t){if(void 0!==e.evalList){const a=Utility.trimExplode(",",e.evalList)
for(const e of a)t=FormEngineValidation.formatValue(e,t)}return t}static formatValue(e,t){switch(e){case"date":case"datetime":case"time":case"timesec":if(""===t||"0"===t)return""
const e=DateTime.fromISO(String(t),{zone:"utc"})
if(!e.isValid)throw new Error("Invalid ISO8601 DateTime string: "+t)
return e.toISO({suppressMilliseconds:!0})
...
if(void 0!==t.dataset.config){const e=JSON.parse(t.dataset.config),i=FormEngineValidation.processByEvals(e,a.value),n=FormEngineValidation.formatByEvals(e,i)
t.value!==i&&(t.disabled&&t.dataset.enableOnModification&&(t.disabled=!1),t.value=i,t.dispatchEvent(new Event("change"))),a.value!==n&&(a.value=n)}}static validateField(e){if(void 0===e.dataset.formengineValidationRules)return
let t=e.value||""
...
break
case"range":if(""!==t){if((l.minItems||l.maxItems)&&(i=formEngineFormElement.querySelector(selector`[name="${e.dataset.relatedfieldname}"]`),s=null!==i?Utility.trimExplode(",",i.value).length:parseInt(e.value,10),void 0!==l.minItems&&(n=1*l.minItems,!isNaN(n)&&s<n&&(o=!0)),void 0!==l.maxItems&&(r=1*l.maxItems,!isNaN(r)&&s>r&&(o=!0))),void 0!==l.lower)if("datetimepicker"===e.dataset.inputType){const e=DateTime.fromISO(t,{zone:"utc"}),a=DateTime.fromISO(l.lower,{zone:"utc"});(!e.isValid||e<a.minus(1e3*a.second))&&(o=!0)}else{const e=1*l.lower
!isNaN(e)&&parseInt(t,10)<e&&(o=!0)}if(void 0!==l.upper)if("datetimepicker"===e.dataset.inputType){const e=DateTime.fromISO(t,{zone:"utc"}),a=DateTime.fromISO(l.upper,{zone:"utc"});(!e.isValid||e>a.plus(1e3*(59-a.second)))&&(o=!0)}else{const e=1*l.upper
!isNaN(e)&&parseInt(t,10)>e&&(o=!0)}}break
case"select":case"category":(l.minItems||l.maxItems)&&(i=formEngineFormElement.querySelector(selector`[name="${e.dataset.relatedfieldname}"]`),s=null!==i?Utility.trimExplode(",",i.value).length:e instanceof HTMLSelectElement?e.querySelectorAll("option:checked").length:e.querySelectorAll("input[value]:checked").length,void 0!==l.minItems&&(n=1*l.minItems,!isNaN(n)&&s<n&&(o=!0)),void 0!==l.maxItems&&(r=1*l.maxItems,!isNaN(r)&&s>r&&(o=!0)))
break
...
break
case"min":(e instanceof HTMLInputElement||e instanceof HTMLTextAreaElement)&&e.value.length>0&&e.value.length<e.minLength&&(o=!0)}}const l=!o
e.classList.toggle(FormEngineValidation.errorClass,!l),e.closest(FormEngineValidation.markerSelector)?.querySelector(FormEngineValidation.labelSelector)?.classList.toggle(FormEngineValidation.errorClass,!l),FormEngineValidation.markParentTab(e,l),formEngineFormElement.dispatchEvent(new CustomEvent("t3-formengine-postfieldvalidation",{detail:{field:e,isValid:l},cancelable:!1,bubbles:!0}))}static processByEvals(e,t){if(void 0!==e.evalList){const a=Utility.trimExplode(",",e.evalList)
for(const i of a)t=FormEngineValidation.processValue(i,t,e)}return t}static processValue(e,t,a){let i="",n="",r=0,o=t
switch(e){case"alpha":case"num":case"alphanum":case"alphanum_x":for(i="",r=0;r<t.length;r++){const a=t.substr(r,1)
let n="_"===a||"-"===a,o=a>="a"&&a<="z"||a>="A"&&a<="Z",s=a>="0"&&a<="9"
switch(e){case"alphanum":n=!1
break
case"alpha":s=!1,n=!1
break
case"num":o=!1,n=!1}(o||s||n)&&(i+=a)}i!==t&&(o=i)
break
case"is_in":if(a.is_in){n=""+t,a.is_in=a.is_in.replace(/[-[\]{}()*+?.,\\^$|#\s]/g,"\\$&")
const e=new RegExp("[^"+a.is_in+"]+","g")
i=n.replace(e,"")}else i=n
o=i
break
...
case"year":if(""!==t){let e=parseInt(t,10)
isNaN(e)&&(e=(new Date).getUTCFullYear()),o=e.toString(10)}break
...
const t=e||document
for(const e of t.querySelectorAll(FormEngineValidation.rulesSelector))null===e.closest(".t3js-flex-section-deleted, .t3js-inline-record-deleted, .t3js-file-reference-deleted")&&FormEngineValidation.validateField(e)}static markFieldAsChanged(e){e.classList.add("has-change")
...
return isNaN(t)?0:t}static parseDouble(e,t=2){let a=""+e
a=a.replace(/[^0-9,.-]/g,"")
const i=a.startsWith("-")
a=a.replace(/-/g,""),a=a.replace(/,/g,"."),-1===a.indexOf(".")&&(a+=".0")
const n=a.split("."),r=n.pop()
let o=Number(n.join("")+"."+r)
return i&&(o*=-1),a=o.toFixed(t),a}static pol(foreign,value){return eval(("-"==foreign?"-":"")+value)}static markParentTab(e,t){DomHelper.parents(e,".tab-pane").forEach((e=>{t&&(t=null===e.querySelector(".has-error"))
const a=e.id
