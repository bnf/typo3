...
i!==this.valuePicker&&(this.valuePicker?.removeEventListener("change",this.onChange),this.valuePicker=i,this.valuePicker?.addEventListener("change",this.onChange),this.initialValueSet=!1),this.setInitialPickerValue()}setInitialPickerValue(){if(null!==this.linkedField&&null!==this.valuePicker&&!this.initialValueSet&&this.getInsertMode()===e.replace){const i=document.getElementsByName(this.linkedField.dataset.formengineInputName)[0]??null
null!==i&&(this.selectValue(i.value),this.initialValueSet=!0)}}selectValue(e){this.valuePicker.selectedIndex=Array.from(this.valuePicker.options).findIndex((i=>i.value===e))}getInsertMode(){return this.getAttribute("mode")??e.replace}setValue(){const i=this.valuePicker.options[this.valuePicker.selectedIndex].value
