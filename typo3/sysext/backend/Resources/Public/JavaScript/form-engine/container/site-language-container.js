...
import{default as i}from"@typo3/backend/modal.js"
...
this.deleteRecord(o,e)}}}static getInlineRecordContainer(e){return document.querySelector(d`[data-object-id="${e}"]`)}static getValuesFromHashMap(e){return Object.keys(e).map((t=>e[t]))}static selectOptionValueExists(e,t){return null!==e.querySelector(d`option[value="${t}"]`)}static removeSelectOptionByValue(e,t){const o=e.querySelector(d`option[value="${t}"]`)
null!==o&&o.remove()}static reAddSelectOption(e,t,o){if(h.selectOptionValueExists(e,t))return
const r=e.querySelectorAll("option")
let n=-1
for(const e of Object.keys(o.possible)){if(e===t)break
for(let t=0;t<r.length;++t){if(r[t].value===e){n=t
break}}}-1===n?n=1:n<r.length&&n++
const i=document.createElement("option")
i.text=o.possible[t],i.value=t,e.insertBefore(i,e.options[n])}static collapseExpandRecord(e){const t=h.getInlineRecordContainer(e),o=document.querySelector(d`[aria-controls="${e}_fields"]`)
...
if(""===r)return
let n=this.container.dataset.objectGroup
void 0!==t.dataset.recordUid&&(n+=m.structureSeparator+t.dataset.recordUid),o.value="",this.importRecord([n,"",r],t.dataset.recordUid??null)})).delegateTo(this.container,u.createNewRecordPresetSelector)}registerCreateRecordBySelector(){new s("change",((e,t)=>{e.preventDefault(),e.stopImmediatePropagation()
...
i.confirm(o,r,l.warning,[{text:TYPO3.lang["buttons.confirm.delete_record.no"]||"Cancel",active:!0,btnClass:"btn-default",name:"no",trigger:(e,t)=>t.hideModal()},{text:TYPO3.lang["buttons.confirm.delete_record.yes"]||"Yes, delete this record",btnClass:"btn-warning",name:"yes",trigger:(e,o)=>{this.deleteRecord(t.closest("[data-object-id]").dataset.objectId),o.hideModal()}}])})).delegateTo(this.container,u.deleteRecordButtonSelector)}createRecord(e,t,o=null,r=null){let n=this.container.dataset.objectGroup
null!==o?(n+=m.structureSeparator+o,h.getInlineRecordContainer(n).insertAdjacentHTML("afterend",t),this.memorizeAddRecord(e,o,r)):(document.getElementById(this.container.getAttribute("id")+"_records").insertAdjacentHTML("beforeend",t),this.memorizeAddRecord(e,null,r))}async importRecord(e,t){return this.ajaxDispatcher.send(this.ajaxDispatcher.newRequest(this.ajaxDispatcher.getEndpoint("site_configuration_inline_create")),e).then((async e=>{this.createRecord(e.compilerInput.uid,e.data,void 0!==t?t:null,void 0!==e.compilerInput.childChildUid?e.compilerInput.childChildUid:null)}))}loadRecordDetails(e){const t=document.getElementById(e+"_fields"),o=h.getInlineRecordContainer(e),i=void 0!==this.requestQueue[e]
...
if(i)this.requestQueue[e].abort(),delete this.requestQueue[e],delete this.progressQueue[e],a.done()
else{const i=this.ajaxDispatcher.newRequest(this.ajaxDispatcher.getEndpoint("site_configuration_inline_details"))
this.ajaxDispatcher.send(i,[e]).then((async i=>{delete this.requestQueue[e],delete this.progressQueue[e],o.classList.remove(p.notLoaded),t.innerHTML=i.data,h.collapseExpandRecord(e),a.done(),r.reinitialize(),n.initializeInputFields(),n.validate(this.container),this.removeUsed(h.getInlineRecordContainer(e))})),this.requestQueue[e]=i,a.start()}}}memorizeAddRecord(e,t=null,o=null){const i=this.getFormFieldForElements()
if(null===i)return
let a=c.trimExplode(",",i.value)
if(t){const o=[]
for(let r=0;r<a.length;r++)a[r].length&&o.push(a[r]),t===a[r]&&o.push(e)
a=o}else a.push(e)
i.value=a.join(","),n.markFieldAsChanged(i),document.dispatchEvent(new Event("change")),this.setUnique(e,o),r.reinitialize(),n.initializeInputFields(),n.validate(this.container)}memorizeRemoveRecord(e){const t=this.getFormFieldForElements()
if(null===t)return[]
const o=c.trimExplode(",",t.value),r=o.indexOf(e)
return r>-1&&(o.splice(r,1),t.value=o.join(","),n.markFieldAsChanged(t),document.dispatchEvent(new Event("change"))),o}deleteRecord(e,t=!1){const o=h.getInlineRecordContainer(e),r=o.dataset.objectUid
if(o.classList.add("t3js-inline-record-deleted"),!o.classList.contains(p.new)&&!t){const e=this.container.querySelector(d`[name="cmd${o.dataset.fieldName}[delete]"]`)
e.removeAttribute("disabled"),o.parentElement.insertAdjacentElement("afterbegin",e)}new s("transitionend",(()=>{o.remove(),n.validate(this.container)})).bindTo(o),this.revertUnique(r),this.memorizeRemoveRecord(r),o.classList.add("form-irre-object--deleted")}getProgress(e,t){const r="#"+t+"_header"
let n
return void 0!==this.progressQueue[e]?n=this.progressQueue[e]:(n=o,n.configure({parent:r,showSpinner:!1}),this.progressQueue[e]=n),n}getFormFieldForElements(){const e=document.getElementsByName(this.container.dataset.formField)
...
if(null!==r){const e=r.options[r.selectedIndex].value
for(const t of o)t!==e&&h.removeSelectOptionByValue(r,t)}}setUnique(e,t){const o=TYPO3.settings.FormEngineInline.unique[this.container.dataset.objectGroup],r=document.getElementById(this.container.dataset.objectGroup+"_selector")
if(-1!==o.max){const n=this.getFormFieldForElements(),i=this.container.dataset.objectGroup+m.structureSeparator+e
let a=h.getInlineRecordContainer(i).querySelector('[name="data['+o.table+"]["+e+"]["+o.field+']"]')
const s=h.getValuesFromHashMap(o.used)
if(null!==r){if(null!==a)for(const e of s)h.removeSelectOptionByValue(a,e)
for(const e of s)h.removeSelectOptionByValue(a,e)
void 0!==o.used.length&&(o.used={}),o.used[e]={table:o.elTable,uid:t}}if(null!==n&&h.selectOptionValueExists(r,t)){const r=c.trimExplode(",",n.value)
for(const n of r)a=document.querySelector('[name="data['+o.table+"]["+n+"]["+o.field+']"]'),null!==a&&n!==e&&h.removeSelectOptionByValue(a,t)}}h.selectOptionValueExists(r,t)&&(h.removeSelectOptionByValue(r,t),o.used[e]={table:o.elTable,uid:t})}revertUnique(e){const t=TYPO3.settings.FormEngineInline.unique[this.container.dataset.objectGroup],o=this.container.dataset.objectGroup+m.structureSeparator+e,r=h.getInlineRecordContainer(o),n=r.querySelector('[name="data['+t.table+"]["+r.dataset.objectUid+"]["+t.field+']"]')
let i
if(null!==n)i=n.value
else{if(""===r.dataset.tableUniqueOriginalValue)return
i=r.dataset.tableUniqueOriginalValue.replace(t.table+"_","")}if("9223372036854775807"!==i){const e=document.getElementById(this.container.dataset.objectGroup+"_selector")
h.reAddSelectOption(e,i,t)}if(-1===t.max)return
const a=this.getFormFieldForElements()
if(null===a)return
const s=c.trimExplode(",",a.value)
let l
for(let e=0;e<s.length;e++)l=document.querySelector('[name="data['+t.table+"]["+s[e]+"]["+t.field+']"]'),null!==l&&h.reAddSelectOption(l,i,t)
