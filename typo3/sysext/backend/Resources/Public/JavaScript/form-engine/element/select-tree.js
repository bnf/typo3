 ...
 */
var e=function(e,t,s,i){var n,d=arguments.length,o=d<3?t:null===i?i=Object.getOwnPropertyDescriptor(t,s):i
if("object"==typeof Reflect&&"function"==typeof Reflect.decorate)o=Reflect.decorate(e,t,s,i)
else for(var c=e.length-1;c>=0;c--)(n=e[c])&&(o=(d<3?n(o):d>3?n(t,s,o):n(t,s))||o)
return d>3&&o&&Object.defineProperty(t,s,o),o}
...
return this.isNodeSelectable(e)||s?e.checked?i="actions-check-square":e.__indeterminate&&!s&&(i="actions-minus-square"):i="actions-minus-circle",t`<span class="node-select"><typo3-backend-icon identifier="${i}" size="small"></typo3-backend-icon></span>`}prepareLoadedNodes(e){const t=e.detail.nodes
e.detail.nodes=t.map((e=>(!1===e.selectable&&this.settings.unselectableElements.push(e.identifier),e)))}handleExclusiveNodeSelection(e){const t=this.settings.exclusiveNodesIdentifiers.split(",")
this.settings.exclusiveNodesIdentifiers.length&&!1===e.checked&&(t.indexOf(""+e.identifier)>-1?(this.resetSelectedNodes(),this.exclusiveSelectedNode=e):-1===t.indexOf(""+e.identifier)&&this.exclusiveSelectedNode&&(this.exclusiveSelectedNode.checked=!1,this.exclusiveSelectedNode=null))}}
e([n()],d.prototype,"settings",void 0),e([n()],d.prototype,"exclusiveSelectedNode",void 0),d=e([i("typo3-backend-form-selecttree")],d)
export{d as SelectTree}
