...
import{JavaScriptItemProcessor as t}from"@typo3/core/java-script-item-processor.js"
import s from"@typo3/backend/notification.js"
import n from"@typo3/backend/utility.js"
export class AjaxDispatcher{constructor(e){this.objectGroup=null,this.objectGroup=e}newRequest(t){return new e(t)}getEndpoint(e){if(void 0!==TYPO3.settings.ajaxUrls[e])return TYPO3.settings.ajaxUrls[e]
throw'Undefined endpoint for route "'+e+'"'}send(e,t){const n=e.post(this.createRequestBody(t)).then((async e=>this.processResponse(await e.resolve())))
