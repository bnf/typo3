...
var e=function(e,t,o,i){var r,a=arguments.length,n=a<3?t:null===i?i=Object.getOwnPropertyDescriptor(t,o):i;if("object"==typeof Reflect&&"function"==typeof Reflect.decorate)n=Reflect.decorate(e,t,o,i);else for(var s=e.length-1;s>=0;s--)(r=e[s])&&(n=(a<3?r(n):a>3?r(t,o,n):r(t,o))||n);return a>3&&n&&Object.defineProperty(t,o,n),n};import{customElement as t,property as o}from"lit/decorators.js";import{html as i,css as r,LitElement as a,nothing as n}from"lit";import s from"@typo3/backend/modal.js";import"@typo3/backend/element/icon-element.js";import l from"@typo3/core/ajax/ajax-request.js";import{lll as c}from"@typo3/core/lit-helper.js";import d from"@typo3/backend/notification.js";import p from"@typo3/backend/viewport.js";import m from"@typo3/core/event/regular-event.js";import{KeyTypesEnum as g}from"@typo3/backend/enum/key-types.js";class h{constructor(e,t,o,i,r,a,n,s,l){this.identifier=e,this.label=t,this.description=o,this.icon=i,this.url=r,this.requestType=a,this.defaultValues=n,this.saveAndClose=s,this.event=l,this.visible=!0}static fromData(e){return new h(e.identifier,e.label,e.description,e.icon,e.url??null,e.requestType??"location",e.defaultValues??[],e.saveAndClose??!1,e.event??null)}reset(){this.visible=!0}}export class Category{constructor(e,t,o){this.identifier=e,this.label=t,this.items=o,this.disabled=!1}static fromData(e){return new Category(e.identifier,e.label,e.items.map((e=>h.fromData(e))))}reset(){this.disabled=!1,this.items.forEach((e=>{e.reset()}))}activeItems(){return this.items.filter((e=>e.visible))??[]}}export class Categories{constructor(e){this.items=e}static fromData(e){return new Categories(Object.values(e).map((e=>Category.fromData(e))))}reset(){this.items.forEach((e=>{e.reset()}))}categoriesWithItems(){return this.items.filter((e=>e.activeItems().length>0))??[]}}let v=class extends a{constructor(){super(...arguments),this.categories=new Categories([]),this.searchPlaceholder="newRecordWizard.filter.placeholder",this.searchNothingFoundLabel="newRecordWizard.filter.noResults",this.selectedCategory=null,this.searchTerm="",this.messages=[],this.toggleMenu=!1}static{this.styles=[r`:host{display:block;container-type:inline-size}.element{display:flex;flex-direction:column;gap:var(--typo3-spacing);font-size:var(--typo3-component-font-size);line-height:var(--typo3-component-line-height)}.main{width:100%;display:flex;flex-direction:column;gap:calc(var(--typo3-spacing) * 2)}
      ...
      .item{cursor:pointer;display:flex;gap:calc(var(--typo3-spacing)/ 2);text-align:start;border:var(--typo3-component-border-width) solid transparent;border-radius:var(--typo3-component-border-radius);padding:var(--typo3-list-item-padding-y) var(--typo3-list-item-padding-x);background:0 0;color:inherit}.item:hover{color:var(--typo3-component-hover-color);background:var(--typo3-component-hover-bg);border-color:var(--typo3-component-hover-border-color)}.item:focus{outline:0;color:var(--typo3-component-focus-color);background:var(--typo3-component-focus-bg);border-color:var(--typo3-component-focus-border-color)}.item-body-label{text-wrap:balance;font-weight:700;margin-bottom:.25rem}.item-body-description{opacity:.75;text-wrap:pretty}`]}firstUpdated(){const e=document.createElement("link");e.setAttribute("rel","stylesheet"),e.setAttribute("href",TYPO3.settings.cssUrls.backend),this.shadowRoot.appendChild(e);this.renderRoot.querySelector('input[name="search"]').focus(),this.selectAvailableCategory()}getLanguageLabel(e){const t=c(e);return""!==t?t:e}selectAvailableCategory(){0===this.categories.categoriesWithItems().filter((e=>e===this.selectedCategory)).length&&(this.selectedCategory=this.categories.categoriesWithItems()[0]??null),this.messages=[],null===this.selectedCategory&&(this.messages=[{message:this.getLanguageLabel(this.searchNothingFoundLabel),severity:"info"}])}filter(e){this.searchTerm=e,this.categories.reset(),this.categories.items.forEach((e=>{const t=e.label.trim().replace(/\s+/g," ");!(""!==this.searchTerm&&!RegExp(this.searchTerm,"i").test(t))||e.items.forEach((e=>{const t=e.label.trim().replace(/\s+/g," ")+e.description.trim().replace(/\s+/g," ");e.visible=!(""!==this.searchTerm&&!RegExp(this.searchTerm,"i").test(t))})),e.disabled=0===e.items.filter((e=>e.visible)).length})),this.selectAvailableCategory()}render(){return i`<div class="element">${this.renderFilter()} ${this.renderMessages()} ${null===this.selectedCategory?n:i`<div class="main"><div class="navigation">${this.renderNavigationToggle()} ${this.renderNavigationList()}</div><div class="content">${this.renderCategories()}</div></div>`}</div>`}renderFilter(){return i`<form class="filter" @submit="${e=>e.preventDefault()}"><input name="search" type="search" autocomplete="off" class="form-control" .value="${this.searchTerm}" @input="${e=>{this.filter(e.target.value)}}" @keydown="${e=>{e.key===g.ESCAPE&&(e.stopImmediatePropagation(),this.filter(""))}}" placeholder="${this.getLanguageLabel(this.searchPlaceholder)}"></form>`}renderMessages(){return i`${this.messages.length>0?i`<div class="messages">${this.messages.map((e=>i`<div class="alert alert-${e.severity}" role="alert">${e.message}</div>`))}</div>`:n}`}renderNavigationToggle(){return i`<button class="navigation-toggle btn btn-light" @click="${()=>{this.toggleMenu=!this.toggleMenu}}">${this.selectedCategory.label}<typo3-backend-icon identifier="actions-chevron-${!0===this.toggleMenu?"up":"down"}" size="small"></typo3-backend-icon></button>`}renderNavigationList(){return i`<div class="navigation-list${!0===this.toggleMenu?" show":""}" role="tablist">${this.categories.items.map((e=>i`<button data-identifier="${e.identifier}" class="navigation-item${this.selectedCategory===e?" active":""}" ?disabled="${e.disabled}" @click="${()=>{this.selectedCategory=e,this.toggleMenu=!1}}"><span class="navigation-item-label">${e.label}</span> <span class="navigation-item-count">${e.activeItems().length}</span></button>`))}</div>`}renderCategories(){return i`<div class="elementwizard-categories">${this.categories.items.map((e=>this.renderCategory(e)))}</div>`}renderCategory(e){return i`${this.selectedCategory===e?i`<div class="item-list">${e.items.map((e=>this.renderCategoryButton(e)))}</div>`:n}`}renderCategoryButton(e){return i`${e.visible?i`<button type="button" class="item" data-identifier="${e.identifier}" @click="${t=>{t.preventDefault(),this.handleItemClick(e)}}"><div class="item-icon"><typo3-backend-icon identifier="${e.icon||"empty-empty"}" size="medium"></typo3-backend-icon></div><div class="item-body"><div class="item-body-label">${e.label}</div><div class="item-body-description">${e.description}</div></div></button>`:n}`}handleItemClick(e){if("event"===e.requestType){const t=new CustomEvent(e.event,{detail:{item:e}});return this.dispatchEvent(t),void s.dismiss()}if(""!==e.url.trim())return"location"===e.requestType?(p.ContentContainer.setUrl(e.url),void s.dismiss()):void("ajax"===e.requestType&&new l(e.url).post({defVals:e.defaultValues,saveAndClose:e.saveAndClose?"1":"0"}).then((async e=>{const t=document.createRange().createContextualFragment(await e.resolve());s.currentModal.addEventListener("modal-updated",(()=>{new m("click",((e,t)=>{e.preventDefault();const o=t.dataset.target;o&&(p.ContentContainer.setUrl(o),s.dismiss())})).delegateTo(s.currentModal,"button[data-target]")})),s.currentModal.setContent(t)})).catch((()=>{d.error("Could not load module data")})))}};e([o({type:Object,converter:{fromAttribute:e=>{const t=JSON.parse(e);return Categories.fromData(t)}}})],v.prototype,"categories",void 0),e([o({type:String})],v.prototype,"searchPlaceholder",void 0),e([o({type:String})],v.prototype,"searchNothingFoundLabel",void 0),e([o({type:String,attribute:!1})],v.prototype,"selectedCategory",void 0),e([o({type:String,attribute:!1})],v.prototype,"searchTerm",void 0),e([o({type:Array,attribute:!1})],v.prototype,"messages",void 0),e([o({type:Boolean,attribute:!1})],v.prototype,"toggleMenu",void 0),v=e([t("typo3-backend-new-record-wizard")],v);export{v as NewRecordWizard};