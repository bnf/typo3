 ...
 */
import t from"@typo3/backend/info-window.js"
import e from"@typo3/core/event/regular-event.js"
import s from"@typo3/backend/toolbar/shortcut-menu.js"
import r from"@typo3/backend/window-manager.js"
...
case"{$event}":return t
default:return s}}))),this.delegates[s]&&this.delegates[s].apply(null,r||[])}}export default new i
