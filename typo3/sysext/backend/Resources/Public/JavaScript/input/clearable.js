...
const l=t.createCloseButton(n),a=()=>{l.style.visibility=0===this.value.length?"hidden":"visible"}
l.addEventListener("click",(t=>{t.preventDefault(),this.value="","function"==typeof options.onClear&&options.onClear(this),this.dispatchEvent(new Event("change",{bubbles:!0,cancelable:!0})),this.dispatchEvent(new CustomEvent("typo3:internal:clear")),a()})),e.appendChild(l),this.addEventListener("focus",a),this.addEventListener("keyup",a),a(),this.isClearable=!0}}}export default new t
