 ...
 */
var ClipboardPanel_1,CopyMode,__decorate=this&&this.__decorate||function(t,e,i,a){var o,n=arguments.length,l=n<3?e:null===a?a=Object.getOwnPropertyDescriptor(e,i):a;if("object"==typeof Reflect&&"function"==typeof Reflect.decorate)l=Reflect.decorate(t,e,i,a);else for(var r=t.length-1;r>=0;r--)(o=t[r])&&(l=(n<3?o(l):n>3?o(e,i,l):o(e,i))||l);return n>3&&l&&Object.defineProperty(e,i,l),l};import{html,LitElement}from"lit";import{customElement,property}from"lit/decorators";import{until}from"lit/directives/until";import{unsafeHTML}from"lit/directives/unsafe-html";import{classMap}from"lit/directives/class-map";import AjaxRequest from"TYPO3/CMS/Core/Ajax/AjaxRequest";import Notification from"TYPO3/CMS/Backend/Notification";import"TYPO3/CMS/Backend/Element/SpinnerElement";import"TYPO3/CMS/Backend/Element/IconElement";!function(t){t.cut="cut",t.copy="copy"}(CopyMode||(CopyMode={}));let ClipboardPanel=ClipboardPanel_1=class extends LitElement{constructor(){super(...arguments),this.returnUrl="",this.table=""}static renderLoader(){return html`
