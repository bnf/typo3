    ...
    constructor() {
        ...
        this.registerSortableEventHandler = (fieldElement) => {
            ...
            aside.addEventListener('click', (e) => {
                ...
                const relatedField = FormEngine.getFieldElement(relatedFieldName).get(0);
                const relatedAvailableValuesField = FormEngine.getFieldElement(relatedFieldName, '_avail').get(0);
                if (target.classList.contains('t3js-btn-moveoption-top')) {
                    ...
                    AbstractSortableSelectItems.removeOption(fieldElement, relatedAvailableValuesField);
                }
