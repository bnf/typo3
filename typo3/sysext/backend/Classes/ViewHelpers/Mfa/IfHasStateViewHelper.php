...
class IfHasStateViewHelper extends AbstractConditionViewHelper
{
    public function initializeArguments(): void
    {
        ...
        $this->registerArgument('state', 'string', 'The state to check for (e.g. active)', true);
        $this->registerArgument('provider', MfaProviderInterface::class, 'The provider in question', true);
    }
    ...
    public static function verdict(array $arguments, RenderingContextInterface $renderingContext): bool
    {
        ...
        return is_callable([$provider, $stateMethod]) && $provider->{$stateMethod}($GLOBALS['BE_USER']);
    }
}
