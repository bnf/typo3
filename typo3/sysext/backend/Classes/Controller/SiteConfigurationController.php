...
class SiteConfigurationController
{
    ...
    public function editAction(ServerRequestInterface $request): ResponseInterface
    {
        ...
        $this->configureEditViewDocHeader($view, $formDataCompilerInput['customData']['siteIdentifier']);
        $view->setTitle(
            $this->getLanguageService()->sL('LLL:EXT:backend/Resources/Private/Language/locallang_siteconfiguration_module.xlf:mlang_tabs_tab'),
            $siteIdentifier ?? ''
        );
    ...
    protected function configureEditViewDocHeader(ModuleTemplate $view, string $siteIdentifier): void
    {
        ...
        if ($siteIdentifier) {
            $exportButton = $buttonBar->makeLinkButton()
                // @todo
                //->setTitle($lang->sL('LLL:EXT:backend/Resources/Private/Language/locallang_sitesettings.xlf:overview.edit.title'))
                ->setTitle('Edit Site Settings')
