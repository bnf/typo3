...
readonly class SiteSettingsController
{
    ...
    public function editAction(ServerRequestInterface $request): ResponseInterface
    {
        ...
        $this->addDocHeaderExportButton($view);
        ...
        foreach ($definitions as $definition) {
            ...
            $editableSettings[] = new EditableSetting(
                ...
                typeImplementation: '@typo3/backend/settings/type/' . $definition->type . '.js',
            );
        }
    ...
    public function saveAction(ServerRequestInterface $request): ResponseInterface
    {
        ...
        $changes = $this->writeSettings($site, $parsedBody['settings'] ?? []);
     ...
     */
    private function writeSettings(Site $site, array $rawSettings)
    {
        $settings = [];
        $localSettings = [];
        ...
        try {
            $this->siteWriter->writeSettings($site->getIdentifier(), $settingsTree);
    ...
    protected function addDocHeaderCloseAndSaveButtons(ModuleTemplate $moduleTemplate): void
    {
        ...
        $closeButton = $buttonBar->makeLinkButton()
            ...
            ->setHref((string)$this->uriBuilder->buildUriFromRoute('site_settings'))
    ...
    protected function addDocHeaderExportButton(ModuleTemplate $moduleTemplate): void
    {
        $languageService = $this->getLanguageService();
        $buttonBar = $moduleTemplate->getDocHeaderComponent()->getButtonBar();
        $exportButton = $buttonBar->makeLinkButton()
            ...
            ->setShowLabelText(true)
            ->setHref((string)$this->uriBuilder->buildUriFromRoute('site_settings.export'))
