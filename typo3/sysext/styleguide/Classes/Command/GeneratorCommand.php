...
final class GeneratorCommand extends Command
{
    ...
    {
        $this->addArgument('type', InputArgument::OPTIONAL, 'Create page tree data, valid arguments are "tca", "frontend", "frontend-sys-template" and "all"', 'all');
    ...
    protected function execute(InputInterface $input, OutputInterface $output): int
    {
        ...
        switch ($input->getArgument('type')) {
            ...
            case 'all':
                ...
                break;
            default:
                $output->writeln('<error>Please specify a valid action. Choose "tca", "frontend", "frontend-sys-template" or "all"</error>');
                return 1;
        }
