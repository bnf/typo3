...
class ServiceProvider extends AbstractServiceProvider
{
    ...
    {
        return self::new($container, Object\Container\Container::class);
    }

    public static function getObjectManager(ContainerInterface $container): Object\ObjectManager
    {
        $objectManager = self::new($container, Object\ObjectManager::class, [$container->get(Object\Container\Container::class)]);
