...
class ObjectManager implements ObjectManagerInterface
{
    ...
    public function get($objectName, ...$constructorArguments)
    {
        ...
        file_put_contents(PATH_site . '/objectManager_get.log', $objectName . PHP_EOL . '    ' . $caller['class'] . '::' . $caller['function'] . PHP_EOL . '        ' . $childClass['file'] . ' (' . $childClass['line'] . ')' . PHP_EOL, FILE_APPEND);
