...
class Dispatcher implements \TYPO3\CMS\Core\SingletonInterface
{
     ...
     */
    public function __construct(\TYPO3\CMS\Extbase\Object\ObjectManagerInterface $objectManager, ContainerInterface $serviceLocator = null)
    {
    ...
    protected function resolveController(\TYPO3\CMS\Extbase\Mvc\RequestInterface $request)
    {
        ...
        if ($this->serviceLocator && $this->serviceLocator->has($controllerObjectName)) {
            $controller = $this->serviceLocator->get($controllerObjectName);
        } else {
