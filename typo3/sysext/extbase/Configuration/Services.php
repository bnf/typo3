    ...
    $container->addCompilerPass(
        new class implements CompilerPassInterface {
            public function process(ContainerBuilder $container)
            {
                ...
                // HEADS UP #1: This requires ext_localconf.php to be loaded during container building
                // HEADS UP #2: Due to #1 this will fail (in the sense of being incomplete) if alternativeImplementations are based on conditions in ext_localconf.php
                // @todo maybe we can just drop this and be breaking here as ExtbaseContainer is marked 'internal'.
                // but we sugguested registerImplementation as solution for the removed typoscript settings in
                // https://docs.typo3.org/typo3cms/extensions/core/Changelog/9.5/Deprecation-86270-ExtbaseXclassViaTypoScriptSettings.html#migration
