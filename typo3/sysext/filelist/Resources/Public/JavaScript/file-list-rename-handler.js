...
import{FileListActionEvent as r}from"@typo3/filelist/file-list-actions.js"
...
export default new class{constructor(){new e(r.rename,(e=>{const t=e.detail,r=t.resources[0],i=n.advanced({title:TYPO3.lang["file_rename.title"]||"Rename",type:n.types.default,size:n.sizes.small,content:this.composeEditForm(r),buttons:[{text:TYPO3.lang["file_rename.button.cancel"]||"Cancel",btnClass:"btn-default",name:"cancel",trigger:()=>{i.hideModal()}},{text:TYPO3.lang["file_rename.button.rename"]||"Rename",btnClass:"btn-primary",name:"rename",trigger:()=>{const e=i.querySelector("form")
e?.requestSubmit()}}],callback:function(e){const r=e.querySelector("form")
