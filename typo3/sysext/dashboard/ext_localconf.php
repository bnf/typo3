...
call_user_func(function () {
    if (TYPO3_MODE === 'BE') {
        ...
        $icons = [
            ...
            'dashboard-action-delete' => 'dashboard-action-delete.svg',
         ...
         */
        $GLOBALS['TYPO3_CONF_VARS']['BE']['defaultUC']['startModule'] = 'dashboard_dashboard';

        /**
         * Toolbar Item
         */
        $GLOBALS['TYPO3_CONF_VARS']['BE']['toolbarItems'][1580849538] = \TYPO3\CMS\Dashboard\Backend\ToolbarItems\DashboardToolbarItem::class;
    }
});
