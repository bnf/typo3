...
var DashboardWidgetMoveIntend,__decorate=function(e,t,i,a){var s,n=arguments.length,r=n<3?t:null===a?a=Object.getOwnPropertyDescriptor(t,i):a;if("object"==typeof Reflect&&"function"==typeof Reflect.decorate)r=Reflect.decorate(e,t,i,a);else for(var d=e.length-1;d>=0;d--)(s=e[d])&&(r=(n<3?s(r):n>3?s(t,i,r):s(t,i))||r);return n>3&&r&&Object.defineProperty(t,i,r),r};import{html,LitElement,nothing}from"lit";import{customElement,property,state}from"lit/decorators.js";import{repeat}from"lit/directives/repeat.js";import{unsafeHTML}from"lit/directives/unsafe-html.js";import{styleMap}from"lit/directives/style-map.js";import{Task}from"@lit/task";import"@typo3/backend/element/icon-element.js";import AjaxRequest from"@typo3/core/ajax/ajax-request.js";import ClientStorage from"@typo3/backend/storage/client.js";import{lll,delay}from"@typo3/core/lit-helper.js";import Modal from"@typo3/backend/modal.js";import{SeverityEnum}from"@typo3/backend/enum/severity.js";import{AjaxResponse}from"@typo3/core/ajax/ajax-response.js";import{Categories}from"@typo3/backend/new-record-wizard.js";import{topLevelModuleImport}from"@typo3/backend/utility/top-level-module-import.js";import{selector}from"@typo3/core/literals.js";import DomHelper from"@typo3/backend/utility/dom-helper.js";import Notification from"@typo3/backend/notification.js";!function(e){e.start="start",e.end="end",e.left="left",e.right="right",e.up="up",e.down="down"}(DashboardWidgetMoveIntend||(DashboardWidgetMoveIntend={}));const newRecordWizardEventName="typo3:dashboard:widget:add";export class DashboardWidgetContentRenderedEvent extends Event{constructor(e){super(DashboardWidgetContentRenderedEvent.eventName,{bubbles:!0,composed:!0,cancelable:!1}),this.widget=e}}DashboardWidgetContentRenderedEvent.eventName="typo3:dashboard:widget:content:rendered";class DashboardWidgetMoveIntendEvent extends Event{constructor(e,t){super(DashboardWidgetMoveIntendEvent.eventName,{bubbles:!0,composed:!0,cancelable:!1}),this.identifier=e,this.intend=t}}DashboardWidgetMoveIntendEvent.eventName="typo3:dashboard:widget:moveIntend";class DashboardWidgetRemoveEvent extends Event{constructor(e){super(DashboardWidgetRemoveEvent.eventName,{bubbles:!0,composed:!0,cancelable:!1}),this.identifier=e}}DashboardWidgetRemoveEvent.eventName="typo3:dashboard:widget:remove";class DashboardWidgetRefreshEvent extends Event{constructor(e){super(DashboardWidgetRefreshEvent.eventName,{bubbles:!0,composed:!0,cancelable:!1}),this.identifier=e}}DashboardWidgetRefreshEvent.eventName="typo3:dashboard:widget:refresh";class DashboardAddEvent extends Event{constructor(e,t){super(DashboardAddEvent.eventName),this.preset=e,this.title=t}}DashboardAddEvent.eventName="typo3:dashboard:dashboard:add";class DashboardEditEvent extends Event{constructor(e,t){super(DashboardEditEvent.eventName),this.identifier=e,this.title=t}}DashboardEditEvent.eventName="typo3:dashboard:dashboard:edit";class DashboardUpdateEvent extends Event{constructor(e,t,i){super(DashboardUpdateEvent.eventName),this.identifier=e,this.widgets=t,this.widgetPositions=i}}DashboardUpdateEvent.eventName="typo3:dashboard:dashboard:update";class DashboardDeleteEvent extends Event{constructor(e){super(DashboardDeleteEvent.eventName),this.identifier=e}}function createSet(e){const t=new Set;for(let i=0;i<e.height;i++)for(let a=0;a<e.width;a++){const s=`${e.y+i}-${e.x+a}`;t.add(s)}return t}DashboardDeleteEvent.eventName="typo3:dashboard:dashboard:delete";let Dashboard=class extends LitElement{constructor(){super(),this.loading=!1,this.dashboards=[],this.currentDashboard=null,this.columns=4,this.dragInformation=null,this.resizeObserver=null,this.clientStorageIdentifier="dashboard/current_dashboard",this.useViewTransition=!1,this.enableViewTransitions=!0,this.viewTransition=null,this.mql=null,this.dragOverTimeout=null,this.activeElementRef=null,this.mqListener=e=>{this.enableViewTransitions=!e.matches},this.addEventListener(DashboardWidgetRefreshEvent.eventName,(e=>{e.preventDefault();this.getGridItemByIdentifier(e.identifier).querySelector("typo3-dashboard-widget").refresh()})),this.addEventListener(DashboardWidgetRemoveEvent.eventName,(e=>{e.preventDefault();const{identifier:t}=e;new AjaxRequest(TYPO3.settings.ajaxUrls.dashboard_widget_remove).post({dashboard:this.currentDashboard.identifier,identifier:t}).then((async e=>{const i=await e.resolve();if("ok"===i.status){this.currentDashboard.widgets=this.currentDashboard.widgets.filter((e=>e.identifier!==t));for(const[e,i]of Object.entries(this.currentDashboard.widgetPositions)){const a=Number(e);this.currentDashboard.widgetPositions[a]=i.filter((e=>e.identifier!==t))}this.useViewTransition=!0,this.requestUpdate()}else Notification.error("",i.message)}))})),this.addEventListener(DashboardWidgetMoveIntendEvent.eventName,(e=>{e.preventDefault();const{intend:t,identifier:i}=e,a=this.widgetPositionByIdentifier(i);switch(t){case DashboardWidgetMoveIntend.up:a.y=Math.max(0,a.y-1);break;case DashboardWidgetMoveIntend.down:a.y++;break;case DashboardWidgetMoveIntend.left:a.x=Math.max(0,a.x-1);break;case DashboardWidgetMoveIntend.right:a.x=Math.min(this.columns-a.width,a.x+1);break;case DashboardWidgetMoveIntend.end:return document.activeElement instanceof HTMLElement&&document.activeElement.closest("typo3-dashboard")===this&&(this.activeElementRef=document.activeElement),this.widgetPositionsSort(this.currentDashboard.widgetPositions[this.columns]),void this.dispatchEvent(new DashboardUpdateEvent(this.currentDashboard.identifier,this.currentDashboard.widgets,this.currentDashboard.widgetPositions));default:return}this.widgetPositionChange(this.currentDashboard.widgetPositions[this.columns],a),this.updateComplete.then((()=>{const e=this.getGridItemByIdentifier(i);if(e){const i=t!==DashboardWidgetMoveIntend.up;DomHelper.scrollIntoViewIfNeeded(e,i)}}))})),this.addEventListener(DashboardAddEvent.eventName,(e=>{e.preventDefault();const{preset:t,title:i}=e;new AjaxRequest(TYPO3.settings.ajaxUrls.dashboard_dashboard_add).post({preset:t,title:i}).then((async e=>{const t=await e.resolve();if("ok"===t.status){const e=t.dashboard;this.dashboards.push(e);const i=this.getDashboardByIdentifier(e.identifier)||this.getDashboardFirst();this.selectDashboard(i),this.requestUpdate()}else Notification.error("",t.message)}))})),this.addEventListener(DashboardEditEvent.eventName,(e=>{e.preventDefault();const{identifier:t,title:i}=e;new AjaxRequest(TYPO3.settings.ajaxUrls.dashboard_dashboard_edit).post({identifier:t,title:i}).then((async e=>{const i=await e.resolve();if("ok"===i.status){const e=this.dashboards.filter((e=>e.identifier===t))[0],a=this.dashboards.indexOf(e),s=i.dashboard;this.dashboards[a]=s,e.identifier===s.identifier&&this.selectDashboard(s),this.requestUpdate()}else Notification.error("",i.message)}))})),this.addEventListener(DashboardUpdateEvent.eventName,(e=>{e.preventDefault();const{identifier:t,widgets:i,widgetPositions:a}=e;new AjaxRequest(TYPO3.settings.ajaxUrls.dashboard_dashboard_update).post({identifier:t,widgets:i,widgetPositions:a}).then((async e=>{const i=await e.resolve();if("ok"===i.status){const e=this.dashboards.filter((e=>e.identifier===t))[0],a=this.dashboards.indexOf(e),s=i.dashboard;this.dashboards[a]=s,e.identifier===s.identifier&&this.selectDashboard(s),this.requestUpdate()}else Notification.error("",i.message)}))})),this.addEventListener(DashboardDeleteEvent.eventName,(e=>{e.preventDefault();const{identifier:t}=e;new AjaxRequest(TYPO3.settings.ajaxUrls.dashboard_dashboard_delete).post({identifier:t}).then((async e=>{const i=await e.resolve();if("ok"===i.status){this.dashboards=this.dashboards.filter((e=>e.identifier!==t));const e=this.getDashboardFirst();this.selectDashboard(e),this.requestUpdate()}else Notification.error("",i.message)}))}))}connectedCallback(){super.connectedCallback(),this.resizeObserver=new ResizeObserver((e=>{for(const t of e){const{width:e}=t.contentRect;this.columns=e>950?4:e>750?2:1}})),this.resizeObserver.observe(this),"startViewTransition"in document?(this.mql=window.matchMedia("(prefers-reduced-motion: reduce)"),this.mqListener(this.mql),this.mql.addEventListener("change",this.mqListener)):this.enableViewTransitions=!1}disconnectedCallback(){super.disconnectedCallback(),this.resizeObserver?.disconnect(),this.resizeObserver=null,this.mql?.removeEventListener("change",this.mqListener),this.mql=null}firstUpdated(){this.load()}updated(){this.activeElementRef&&(this.activeElementRef.focus(),this.activeElementRef=null)}createRenderRoot(){return this}scheduleUpdate(){const{useViewTransition:e}=this;return this.useViewTransition=!1,e&&this.enableViewTransitions?(async()=>{this.viewTransition=document.startViewTransition((()=>super.scheduleUpdate())),await this.viewTransition.finished,this.viewTransition=null})():super.scheduleUpdate()}render(){return this.loading?this.renderLoader():html`
    ...
    `}getGridItemByIdentifier(e){return this.querySelector(selector`.dashboard-item[data-widget-identifier="${e}"]`)}handleDragStart(e){const t=e.target.closest(".dashboard-item");if(null===t)return void e.preventDefault();const i=t.dataset.widgetIdentifier,a=this.widgetPositionByIdentifier(i),s=t.getBoundingClientRect();this.dragInformation={identifier:i,element:t,height:a.height,width:a.width,offsetY:e.clientY-s.top,offsetX:e.clientX-s.left,currentY:a.y,currentX:a.x,initialPositions:this.currentDashboard.widgetPositions[this.columns].map((e=>({...e})))},e.dataTransfer.setDragImage(t,this.dragInformation.offsetX,this.dragInformation.offsetY),e.dataTransfer.setData("text/plain",""),e.dataTransfer.effectAllowed="move",t.style.opacity="0.5"}handleDragEnd(){this.dragInformation&&(this.dragInformation.element.style.opacity="",this.dragInformation=null,this.widgetPositionsSort(this.currentDashboard.widgetPositions[this.columns]),this.dispatchEvent(new DashboardUpdateEvent(this.currentDashboard.identifier,this.currentDashboard.widgets,this.currentDashboard.widgetPositions)),this.skipCurrentViewTransition())}handleDragOver(e){if(this.dragInformation){e.preventDefault(),e.dataTransfer.dropEffect="move";const t=this.querySelector(".dashboard-grid"),i=t.getBoundingClientRect(),a=parseInt(getComputedStyle(t).gap,10),s=parseInt(getComputedStyle(t).gridAutoRows,10)+a,n=(i.width+a)/this.columns,r=Math.max(0,e.clientY-i.top-this.dragInformation.offsetY),d=Math.max(0,e.clientX-i.left-this.dragInformation.offsetX),o=Math.max(0,Math.round(r/s)),l=Math.max(0,Math.min(Math.round(d/n),this.columns-this.dragInformation.width));this.dragInformation.currentY===o&&this.dragInformation.currentX===l||(this.dragInformation.currentY=o,this.dragInformation.currentX=l,this.dragOverTimeout&&clearTimeout(this.dragOverTimeout),this.dragOverTimeout=window.setTimeout((()=>{if(this.skipCurrentViewTransition(),this.dragInformation){const e=this.widgetPositionByIdentifier(this.dragInformation.identifier);e.y=this.dragInformation.currentY,e.x=this.dragInformation.currentX,this.widgetPositionChange(this.currentDashboard.widgetPositions[this.columns],e)}}),100))}}handleLegacyWidgetRefreshEvent(e){this.dispatchEvent(new DashboardWidgetRefreshEvent(e.identifier))}initializeCurrentDashboard(){this.currentDashboard.widgetPositions=this.currentDashboard.widgetPositions??{};let e=this.currentDashboard.widgetPositions?.[this.columns]??[];const t={small:1,medium:2,large:4},i={small:1,medium:2,large:3};this.currentDashboard.widgets.forEach((a=>{if(void 0===e.find((e=>e.identifier===a.identifier))){const s=i[a.height]??1,n=t[a.width]??1,r={identifier:a.identifier,height:s,width:n<this.columns?n:this.columns,y:0,x:0};e.push(r)}})),e=this.widgetPositionsArrange(e),this.widgetPositionsCollapseRows(e),this.currentDashboard.widgetPositions[this.columns]=e}widgetByIdentifier(e){return this.currentDashboard.widgets.find((t=>t.identifier===e))??null}widgetPositionByIdentifier(e){return this.currentDashboard.widgetPositions[this.columns].find((t=>t.identifier===e))??null}widgetPositionCanPlace(e,t,i,a){return!(t<0||t>this.columns-e.width||i<0)&&a.isDisjointFrom(createSet({...e,x:t,y:i}))}widgetPositionChange(e,t){let i=structuredClone(this.dragInformation?.initialPositions??e);const a=i.findIndex((e=>e.identifier===t.identifier));let s;if(a>-1){const[e]=i.splice(a,1);s={...e},e.y=t.y,e.x=t.x,i.unshift(e)}i=this.widgetPositionsArrange(i,this.dragInformation?.initialPositions??e,s),e.forEach((e=>{const t=i.find((t=>t.identifier===e.identifier));e.y=t.y,e.x=t.x})),this.widgetPositionsCollapseRows(e),this.useViewTransition=!0,this.requestUpdate()}widgetTryPlacementInNeighbourCells(e,t,i){const a=this.columns;for(let i=e.x;i>=Math.max(0,e.x-e.width);i--)if(this.widgetPositionCanPlace(e,i,e.y,t))return{...e,x:i};for(let i=e.y;i>=0;i--)if(this.widgetPositionCanPlace(e,e.x,i,t))return{...e,y:i};for(let i=e.x;i<=Math.min(a,e.x+e.width);i++)if(this.widgetPositionCanPlace(e,i,e.y,t))return{...e,x:i};for(let a=e.y;a<=e.y+(i?.height??3);a++)if(this.widgetPositionCanPlace(e,e.x,a,t))return{...e,y:a};return null}widgetPositionsArrange(e,t,i){let a=new Set;const s=e=>this.widgetPositionCanPlace(e,e.x,e.y,a)?{...e}:null,n=e=>void 0===t?null:this.widgetTryPlacementInNeighbourCells(e,t.reduce(((e,t)=>e.union(createSet(t))),new Set).difference(createSet(i)).union(a),i),r=e=>this.widgetTryPlacementInNeighbourCells(e,a),d=e=>{const t=Math.max(0,e.y),i=Math.max(0,Math.min(this.columns-e.width,e.x)),s=Math.max(0,i),n=this.columns;for(let i=e.y;i<t+100;i++)for(let t=s;t<n;t++)if(this.widgetPositionCanPlace(e,t,i,a))return{...e,x:t,y:i};throw new Error("Logic error: could not occupy cells")};return e.map((e=>{return t=s(e)??n(e)??r(e)??d(e),a=a.union(createSet(t)),t;var t}))}widgetPositionsCollapseRows(e){const t=new Set;e.forEach((e=>{for(let i=0;i<e.height;i++)t.add(e.y+i)}));const i={};let a=0;for(let e=0;e<=Math.max(...t);e++)t.has(e)&&(i[e]=a++);e.forEach((e=>{e.y=i[e.y]}))}widgetPositionsSort(e){e.sort(((e,t)=>e.y!==t.y?e.y-t.y:e.x-t.x))}};__decorate([state()],Dashboard.prototype,"loading",void 0),__decorate([state()],Dashboard.prototype,"dashboards",void 0),__decorate([state()],Dashboard.prototype,"currentDashboard",void 0),__decorate([state()],Dashboard.prototype,"columns",void 0),__decorate([state()],Dashboard.prototype,"dragInformation",void 0),Dashboard=__decorate([customElement("typo3-dashboard")],Dashboard);export{Dashboard};let DashboardWidget=class extends LitElement{constructor(){super(...arguments),this.moving=!1,this.triggerContentRenderedEvent=!1,this.fetchTask=new Task(this,{args:()=>[this.identifier],task:async([e],{signal:t})=>{const i=TYPO3.settings.ajaxUrls.dashboard_widget_get,a=await new AjaxRequest(i).withQueryArguments({widget:e}).get({signal:t}),s=await a.resolve();if("ok"!==s.status)throw new Error(s.message);return s.widget},onComplete:async()=>{this.triggerContentRenderedEvent=!0},onError:e=>{console.error(`Error while retrieving widget [${this.identifier}]: ${e instanceof AjaxResponse?`${e.response.status} ${e.response.statusText}`:e.message}`)}})}get widget(){return this.fetchTask.value??null}refresh(){this.handleRefresh()}createRenderRoot(){return this}updated(){if(this.triggerContentRenderedEvent){this.triggerContentRenderedEvent=!1;const{widget:e}=this;this.dispatchEvent(new DashboardWidgetContentRenderedEvent(e)),this.dispatchEvent(new CustomEvent("widgetContentRendered",{bubbles:!0,detail:this.widget.eventdata}))}}render(){const e=html`
