...
use TYPO3\CMS\Dashboard\Transfer\Dashboard as TransferDashboard;
use TYPO3\CMS\Dashboard\Transfer\WidgetConfiguration as TransferWidgetConfiguration;
use TYPO3\CMS\Dashboard\Transfer\WidgetData as TransferWidgetData;
...
class DashboardAjaxController
{
    ...
    public function getWidget(ServerRequestInterface $request): ResponseInterface
    {
        ...
        return new JsonResponse($widget->jsonSerialize());
    }
    ...
    public function removeWidget(ServerRequestInterface $request): ResponseInterface
    {
        ...
        $widgetIdentifier = (string)($request->getParsedBody()['widget'] ?? '');
        $widgets = $dashboard->getWidgetConfig();
