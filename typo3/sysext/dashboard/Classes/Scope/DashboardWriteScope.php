...
#[AsTaggedItem(index: 'dashboard:write', priority: 49)]
final readonly class DashboardWriteScope implements ScopeInterface
{
    ...
    {
        return 'Dashboard write access';
    }

    public function getDescription(): string
    {
        return 'Create dashboads or widgets';
    }
