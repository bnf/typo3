...
.. confval:: group
   ...
   It is possible to assign groups to Content Blocks. Content Elements and Page
   Types have pre-defined groups from the Core. Record Types need to define
   custom groups. Refer to :ref:`this guide <cb_guide_new_groups>` on how to do
   this.
