...
.. confval:: typeName
   ...
   numbers, which you can't use either: 1, 3, 4, 6, 7, 199, 254.
...
.. confval:: group
   :name: pages-type-group

   :Required: false
   :Type: string
   :Default: default

   By default, all new Page Types are placed in the `default` group.

   .. code-block:: yaml

       group: special

   The Core defines these standard groups, which are always available:
