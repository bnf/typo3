...
final class ContentBlockFrontendRenderingTest extends FunctionalTestCase
{
    ...
    protected array $testExtensionsToLoad = [
        'typo3/sysext/content_blocks/Tests/Fixtures/Extensions/test_content_blocks_b',
        'typo3/sysext/content_blocks/Tests/Fixtures/Extensions/test_content_blocks_c',
    ];
