 ...
 */
var __decorate=function(e,t,i,s){var a,o=arguments.length,n=o<3?t:null===s?s=Object.getOwnPropertyDescriptor(t,i):s;if("object"==typeof Reflect&&"function"==typeof Reflect.decorate)n=Reflect.decorate(e,t,i,s);else for(var r=e.length-1;r>=0;r--)(a=e[r])&&(n=(o<3?a(n):o>3?a(t,i,n):a(t,i))||n);return o>3&&n&&Object.defineProperty(t,i,n),n};import{html,LitElement}from"lit";import{live}from"lit/directives/live.js";import{customElement,property,state}from"lit/decorators.js";import{Task}from"@lit/task";import AjaxRequest from"@typo3/core/ajax/ajax-request.js";import Loader from"@typo3/backend/viewport/loader.js";import PersistentStorage from"@typo3/backend/storage/persistent.js";import"@typo3/backend/element/module.js";import"@typo3/backend/element/icon-element.js";import"@typo3/backend/element/spinner-element.js";export const componentName="typo3-viewpage-module";let ViewPageModule=class extends LitElement{constructor(){super(...arguments),this.active=!1,this.endpoint="",this.size=null,this.custom=null,this.cache=null,this.storagePrefix="moduleData.page_preview.States.",this.task=new Task(this,{task:async([e],{signal:t})=>{const i=await new AjaxRequest(e).get({cache:"no-cache",signal:t});return await i.resolve()},args:()=>[this.endpoint]}),this.handleOrientationChange=()=>{this.size={...this.size,width:this.size.height,height:this.size.width},this.persistCurrentPreset()},this.handleSizeInputChange=(e,t)=>{const i=e.target;i.valueAsNumber&&(this.size=this.custom={...this.size,label:this.custom.label,[t]:i.valueAsNumber},this.persistCustomPresetAfterChange())},this.handlePresetSelection=(e,t)=>{null===t&&(t={label:this.cache.labels.maximized,width:100,height:100});const{label:i,width:s,height:a}=t;this.size={label:i,width:s,height:a},this.persistCurrentPreset()},this.handleRefresh=()=>{const e=this.renderRoot.querySelector("iframe");e&&e.contentWindow.location.reload()}}createRenderRoot(){return this}render(){const e=this.endpoint,t="page_preview",i=this.task.render({pending:()=>{Loader.start();const i=new CustomEvent("typo3-module-load",{bubbles:!0,composed:!0,detail:{url:e,module:t}});return this.dispatchEvent(i),this.task.taskComplete.then((i=>{Loader.finish();const s=new CustomEvent("typo3-module-loaded",{bubbles:!0,composed:!0,detail:{url:e,module:t,title:i.title}});this.dispatchEvent(s),console.log("sending out config module loaded "+e,s)}),(()=>{Loader.finish(),alert("Error")})),null===this.cache?html`<typo3-backend-spinner></typo3-backend-spinner>`:this.renderContent({...this.cache,title:"Loading"},!0)},complete:e=>{const{url:t,labels:i,current:s,custom:a,presetGroups:o}=e;return null===this.size&&(this.size=s,this.custom=a),this.cache={url:t,labels:i,current:s,custom:a,presetGroups:o},this.renderContent(e,!1)},error:()=>html`<p>Failed to Load viewpage module</p>`});return html`<typo3-backend-module>${i}</typo3-backend-module>`}renderContent(e,t){const{url:i,labels:s,presetGroups:a}=e,o=this.size,n=this.custom;return html`
