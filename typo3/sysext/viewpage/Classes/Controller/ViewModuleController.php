    ...
    public function handleRequest(ServerRequestInterface $request): ResponseInterface
    {
        ...
        if (!$this->isValidDoktype($pageId)) {
            return new JsonResponse([
                'empty' => true,
                'error' => $languageService->sL('LLL:EXT:viewpage/Resources/Private/Language/locallang.xlf:noValidPageSelected'),
            ]);
        }
        ...
        if ($targetUri === null || $targetUrl === '') {
            return new JsonResponse([
                'empty' => true,
                'error' => $languageService->sL('LLL:EXT:viewpage/Resources/Private/Language/locallang.xlf:noSiteConfiguration'),
            ]);
        }
