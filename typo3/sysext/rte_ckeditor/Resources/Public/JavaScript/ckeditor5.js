...
import{prefixAndRebaseCss as a}from"@typo3/rte-ckeditor/css-prefixer.js"
import{ClassicEditor as d}from"@ckeditor/ckeditor5-editor-classic"
...
const{importModules:e,removeImportModules:t,width:o,height:r,readOnly:i,debug:n,toolbar:s,placeholder:a,htmlSupport:p,wordCount:u,typo3link:h,removePlugins:f,...g}=this.options
"extraPlugins"in g&&delete g.extraPlugins,"contentsCss"in g&&delete g.contentsCss
const y=await this.resolvePlugins(c,e,t),k={licenseKey:"GPL",...g,toolbar:s,plugins:y,placeholder:a,wordCount:u,typo3link:h||null,removePlugins:f||[]}
void 0!==p&&(k.htmlSupport=m(p)),void 0!==k?.typing?.transformations&&(k.typing.transformations=m(k.typing.transformations)),d.create(this.target[0],k).then((e=>{if(this.applyEditableElementStyles(e,o,r),this.handleWordCountPlugin(e,u),this.applyReadOnly(e,i),e.model.document.on("change:data",(()=>{e.updateSourceElement(),this.target[0].dispatchEvent(new Event("change",{bubbles:!0,cancelable:!0}))})),e.plugins.has("SourceEditing")){const t=e.plugins.get("SourceEditing")
t.on("change:isSourceEditingMode",((o,r,i)=>{for(const[o]of e.editing.view.domRoots)if(i){const r=e.ui.getEditableElement(`sourceEditing:${o}`)
if(!(r instanceof HTMLTextAreaElement))throw new Error("Cannot find textarea related to source editing. Has CKEditor been upgraded?")
new l("input",(()=>{t.updateEditorData()}),100).bindTo(r)}}))}n&&import("@ckeditor/ckeditor5-inspector").then((({default:t})=>t.attach(e,{isCollapsed:!0})))}))}render(){return t`<slot name="textarea"></slot><slot></slot>`}async resolvePlugins(e,t,o){const r=h(o||[]),i=h([...e,...t||[]]).map((e=>{const{module:t}=e
let{exports:o}=e
for(const e of r)e.module===t&&(o=o.filter((t=>!e.exports.includes(t))))
return{module:t,exports:o}})),n=await Promise.all(i.map((async e=>{try{return{module:await import(e.module),exports:e.exports}}catch(t){return console.error(`Failed to load CKEditor5 module ${e.module}`,t),{module:null,exports:[]}}}))),s=[]
n.forEach((({module:e,exports:t})=>{for(const o of t)o in e?s.push(e[o]):console.error(`CKEditor5 plugin export "${o}" not available in`,e)}))
...
try{const t=await new s(e).get()
o=await t.resolve()}catch(t){throw console.error(`Failed to fetch CSS content for CKEditor5 prefixing: "${e}"`,t),new Error}const r=a(o,e,`#${t} .ck-content`),i=new CSSStyleSheet
return await i.replace(r),i}applyEditableElementStyles(e,t,o){const r=e.editing.view,i={"min-height":o,"min-width":t}
Object.keys(i).forEach((e=>{const t=i[e]
if(!t)return
let o
o="number"!=typeof t&&Number.isNaN(Number(o))?t:`${t}px`,r.change((t=>{t.setStyle(e,o,r.document.getRoot())}))}))}handleWordCountPlugin(e,t){if(e.plugins.has("WordCount")&&(t?.displayWords||t?.displayCharacters)){const t=e.plugins.get("WordCount")
this.appendChild(t.wordCountContainer)}}applyReadOnly(e,t){t&&e.enableReadOnlyMode("typo3-lock")}}
...
const o={}
for(const[r,i]of Object.entries(e))o[r]=t(i)??u(i,t)
