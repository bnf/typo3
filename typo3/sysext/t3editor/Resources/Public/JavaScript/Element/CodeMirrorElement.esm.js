 ...
 */
var __decorate=this&&this.__decorate||function(e,t,o,r){var i,n=arguments.length,l=n<3?t:null===r?r=Object.getOwnPropertyDescriptor(t,o):r;if("object"==typeof Reflect&&"function"==typeof Reflect.decorate)l=Reflect.decorate(e,t,o,r);else for(var s=e.length-1;s>=0;s--)(i=e[s])&&(l=(n<3?i(l):n>3?i(t,o,l):i(t,o))||l);return n>3&&l&&Object.defineProperty(t,o,l),l};import CodeMirror from"codemirror";import{LitElement,html,css}from"lit";import{customElement,property,state}from"lit/decorators";import"TYPO3/CMS/Backend/Element/SpinnerElement";let CodeMirrorElement=class extends LitElement{constructor(){super(...arguments),this.addons=["codemirror/addon/display/panel"],this.options={},this.scrollto=0,this.marktext=[],this.lineDigits=0,this.autoheight=!1,this.nolazyload=!1,this.panel="bottom",this.loaded=!1}render(){return html`
      <slot></slot>
      <slot name="codemirror"></slot>
      ${this.loaded?"":html`<typo3-backend-spinner size="large" variant="dark"></typo3-backend-spinner>`}
    `}firstUpdated(){if(this.nolazyload)return void this.initializeEditor(this.firstElementChild);const e={root:document.body};let t=new IntersectionObserver(e=>{e.forEach(e=>{e.intersectionRatio>0&&(t.unobserve(e.target),this.firstElementChild&&"textarea"===this.firstElementChild.nodeName.toLowerCase()&&this.initializeEditor(this.firstElementChild))})},e);t.observe(this)}createPanelNode(e,t){const o=document.createElement("div");o.setAttribute("class","CodeMirror-panel CodeMirror-panel-"+e),o.setAttribute("id","panel-"+e);const r=document.createElement("span");return r.textContent=t,o.appendChild(r),o}initializeEditor(e){const t=this.mode.split("/"),o=this.options;Promise.all([this.mode,...this.addons].map(e=>import(e))).then(()=>{const r=CodeMirror(t=>{const o=document.createElement("div");o.setAttribute("slot","codemirror"),o.appendChild(t),this.insertBefore(o,e)},{value:e.value,extraKeys:{"Ctrl-F":"findPersistent","Cmd-F":"findPersistent","Ctrl-Alt-F":e=>{e.setOption("fullScreen",!e.getOption("fullScreen"))},"Ctrl-Space":"autocomplete",Esc:e=>{e.getOption("fullScreen")&&e.setOption("fullScreen",!1)}},fullScreen:!1,lineNumbers:!0,lineWrapping:!0,mode:t[t.length-1]});Object.keys(o).map(e=>{r.setOption(e,o[e])}),r.on("change",()=>{e.value=r.getValue(),e.dispatchEvent(new CustomEvent("change",{bubbles:!0}))});const i=this.createPanelNode(this.panel,this.label);if(r.addPanel(i,{position:this.panel,stable:!1}),e.getAttribute("rows")){const t=18,o=4;r.setSize(null,parseInt(e.getAttribute("rows"),10)*t+o+i.getBoundingClientRect().height)}else r.getWrapperElement().style.height="auto",r.setOption("viewportMargin",1/0);this.autoheight&&r.setOption("viewportMargin",1/0),this.lineDigits>0&&r.setOption("lineNumberFormatter",e=>e.toString().padStart(this.lineDigits," ")),this.scrollto>0&&r.scrollIntoView({line:this.scrollto,ch:0});for(let e of this.marktext)e.from&&e.to&&r.markText(e.from,e.to,{className:"CodeMirror-markText"});this.loaded=!0})}};CodeMirrorElement.styles=css`
   :host {
     display: block;
     position: relative;
   }
