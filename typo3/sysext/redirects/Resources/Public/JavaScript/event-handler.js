...
return a.then((async t=>{const r=await t.resolve()
"ok"===r.status&&e.success(r.title,r.message),"error"===r.status&&e.error(r.title,r.message)})).catch((()=>{e.error(TYPO3.lang.redirects_error_title,TYPO3.lang.redirects_error_message)})),a}}
